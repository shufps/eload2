...
# [inline (always)]
pub const fn csr (self) -> crate :: common :: Reg < regs :: Csr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0usize) as _) } } } pub mod regs { # [doc = "OPAMP control/status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
PC5 = 0 , # [doc = "PA5 (VM1) used as OPAMP2 inverting input"]
...
PC5 = 0 , # [doc = "PA5 (VM1) used as OPAMP2 inverting input when TCM_EN=1"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum VpSel { _RESERVED_0 = 0 , # [doc = "PB14 used as OPAMP2 non-inverting input"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum VpsSel { _RESERVED_0 = 0 , # [doc = "PB14 used as OPAMP2 non-inverting input when TCM_EN=1"]
