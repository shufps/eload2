...
# [inline (always)]
pub const fn wutr (self) -> crate :: common :: Reg < regs :: Wutr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (20usize) as _) } } # [doc = "Alarm register"]
# [inline (always)]
...
FLOATING = 0 , # [doc = "PCx is forced to push-pull output if LSE is disabled"]
...
LOW = 0 , # [doc = "If the LSE is disabled and PCxMODE = 1, set PCxVALUE to logic high"]
