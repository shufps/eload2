...
# [inline (always)]
pub const fn pdkeyr (self) -> crate :: common :: Reg < u32 , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (4usize) as _) } } # [doc = "Flash key register"]
# [inline (always)]
...
# [inline (always)]
pub const fn wrp1br (self) -> crate :: common :: Reg < regs :: Wrp1br , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (48usize) as _) } } # [doc = "Flash Bank 2 PCROP Start address register"]
# [inline (always)]
pub const fn pcrop2sr (self) -> crate :: common :: Reg < regs :: Pcrop2sr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (68usize) as _) } } # [doc = "Flash Bank 2 PCROP End address register"]
# [inline (always)]
pub const fn pcrop2er (self) -> crate :: common :: Reg < regs :: Pcrop2er , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (72usize) as _) } } # [doc = "Flash Bank 2 WRP area A address register"]
# [inline (always)]
pub const fn wrp2ar (self) -> crate :: common :: Reg < regs :: Wrp2ar , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (76usize) as _) } } # [doc = "Flash Bank 2 WRP area B address register"]
# [inline (always)]
pub const fn wrp2br (self) -> crate :: common :: Reg < regs :: Wrp2br , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (80usize) as _) } } } pub mod regs { # [doc = "Access control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
