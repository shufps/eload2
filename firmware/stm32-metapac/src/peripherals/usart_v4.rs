...
# [inline (always)]
pub const fn cr3 (self) -> crate :: common :: Reg < regs :: Cr3 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize) as _) } } # [doc = "Baud rate register"]
# [inline (always)]
pub const fn brr (self) -> crate :: common :: Reg < regs :: Brr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (12usize) as _) } } # [doc = "Request register"]
# [inline (always)]
pub const fn rqr (self) -> crate :: common :: Reg < regs :: Rqr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (24usize) as _) } } # [doc = "Interrupt & status register"]
# [inline (always)]
pub const fn isr (self) -> crate :: common :: Reg < regs :: Isr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (28usize) as _) } } # [doc = "Interrupt flag clear register"]
# [inline (always)]
pub const fn icr (self) -> crate :: common :: Reg < regs :: Icr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (32usize) as _) } } # [doc = "Receive data register"]
# [inline (always)]
pub const fn rdr (self) -> crate :: common :: Reg < regs :: Dr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (36usize) as _) } } # [doc = "Transmit data register"]
# [inline (always)]
pub const fn tdr (self) -> crate :: common :: Reg < regs :: Dr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (40usize) as _) } } # [doc = "Prescaler register"]
# [inline (always)]
pub const fn presc (self) -> crate :: common :: Reg < regs :: Presc , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (44usize) as _) } } } # [doc = "Universal synchronous asynchronous receiver transmitter"]
# [derive (Copy , Clone , Eq , PartialEq)]
...
pub const fn cr3 (self) -> crate :: common :: Reg < regs :: Cr3 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize) as _) } } # [doc = "Baud rate register"]
# [inline (always)]
pub const fn brr (self) -> crate :: common :: Reg < regs :: Brr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (12usize) as _) } } # [doc = "Guard time and prescaler register"]
# [inline (always)]
pub const fn gtpr (self) -> crate :: common :: Reg < regs :: Gtpr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (16usize) as _) } } # [doc = "Receiver timeout register"]
# [inline (always)]
pub const fn rtor (self) -> crate :: common :: Reg < regs :: Rtor , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (20usize) as _) } } # [doc = "Request register"]
# [inline (always)]
pub const fn rqr (self) -> crate :: common :: Reg < regs :: Rqr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (24usize) as _) } } # [doc = "Interrupt & status register"]
# [inline (always)]
pub const fn isr (self) -> crate :: common :: Reg < regs :: Isr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (28usize) as _) } } # [doc = "Interrupt flag clear register"]
...
pub const fn tdr (self) -> crate :: common :: Reg < regs :: Dr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (40usize) as _) } } # [doc = "Prescaler register"]
# [inline (always)]
pub const fn presc (self) -> crate :: common :: Reg < regs :: Presc , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (44usize) as _) } } } pub mod regs { # [doc = "Baud rate register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
START = 0 , # [doc = "Falling edge to falling edge measurement"]
...
BIT4 = 0 , # [doc = "7-bit address detection"]
...
FIRST = 0 , # [doc = "The second clock transition is the first data capture edge"]
...
LOW = 0 , # [doc = "Steady high value on CK pin outside transmission window"]
...
HIGH = 0 , # [doc = "DE signal is active low"]
...
BIT10 = 0 , # [doc = "11-bit break detection"]
...
BIT8 = 0 , # [doc = "1 start bit, 9 data bits, n stop bits"]
...
M0 = 0 , # [doc = "1 start bit, 7 data bits, n stop bits"]
...
LSB = 0 , # [doc = "data is transmitted/received with MSB (bit 7/8/9) first, following the start bit"]
...
OVERSAMPLING16 = 0 , # [doc = "Oversampling by 8"]
...
DIV1 = 0 , # [doc = "input clock divided by 2"]
...
ACTIVE = 0 , # [doc = "Receiver in mute mode"]
...
IDLELINE = 0 , # [doc = "USART wakeup on address mark"]
...
ADDRESS = 0 , _RESERVED_1 = 0x01 , # [doc = "WuF active on Start bit detection"]
