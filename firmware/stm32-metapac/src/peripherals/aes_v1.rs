...
# [inline (always)]
pub const fn keyr (self , n : usize) -> crate :: common :: Reg < regs :: Keyr , crate :: common :: RW > { assert ! (n < 4usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (16usize + n * 4usize) as _) } } # [doc = "Initialization vector register"]
# [inline (always)]
pub const fn ivr (self , n : usize) -> crate :: common :: Reg < regs :: Ivr , crate :: common :: RW > { assert ! (n < 4usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (32usize + n * 4usize) as _) } } } pub mod regs { # [doc = "Control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
