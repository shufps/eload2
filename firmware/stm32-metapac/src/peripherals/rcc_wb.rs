...
# [inline (always)]
pub const fn cfgr (self) -> crate :: common :: Reg < regs :: Cfgr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize) as _) } } # [doc = "PLLSYS configuration register"]
# [inline (always)]
...
# [inline (always)]
pub const fn pllsai1cfgr (self) -> crate :: common :: Reg < regs :: Pllsai1cfgr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (16usize) as _) } } # [doc = "Clock interrupt enable register"]
# [inline (always)]
...
# [inline (always)]
pub const fn cicr (self) -> crate :: common :: Reg < regs :: Cicr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (32usize) as _) } } # [doc = "Step Down converter control register"]
# [inline (always)]
pub const fn smpscr (self) -> crate :: common :: Reg < regs :: Smpscr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (36usize) as _) } } # [doc = "AHB1 peripheral reset register"]
# [inline (always)]
...
# [inline (always)]
pub const fn crrcr (self) -> crate :: common :: Reg < regs :: Crrcr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (152usize) as _) } } # [doc = "Clock HSE register"]
# [inline (always)]
pub const fn hsecr (self) -> crate :: common :: Reg < regs :: Hsecr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (156usize) as _) } } # [doc = "Extended clock recovery register"]
# [inline (always)]
...
# [inline (always)]
pub const fn c2ahb2enr (self) -> crate :: common :: Reg < regs :: C2ahb2enr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (332usize) as _) } } # [doc = "CPU2 AHB3 peripheral clock enable register"]
# [inline (always)]
pub const fn c2ahb3enr (self) -> crate :: common :: Reg < regs :: C2ahb3enr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (336usize) as _) } } # [doc = "CPU2 APB1ENR1"]
# [inline (always)]
pub const fn c2apb1enr1 (self) -> crate :: common :: Reg < regs :: C2apb1enr1 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (344usize) as _) } } # [doc = "CPU2 APB1 peripheral clock enable register 2"]
# [inline (always)]
pub const fn c2apb1enr2 (self) -> crate :: common :: Reg < regs :: C2apb1enr2 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (348usize) as _) } } # [doc = "CPU2 APB2ENR"]
# [inline (always)]
pub const fn c2apb2enr (self) -> crate :: common :: Reg < regs :: C2apb2enr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (352usize) as _) } } # [doc = "CPU2 APB3ENR"]
# [inline (always)]
pub const fn c2apb3enr (self) -> crate :: common :: Reg < regs :: C2apb3enr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (356usize) as _) } } # [doc = "CPU2 AHB1 peripheral clocks enable in Sleep and Stop modes register"]
# [inline (always)]
pub const fn c2ahb1smenr (self) -> crate :: common :: Reg < regs :: C2ahb1smenr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (360usize) as _) } } # [doc = "CPU2 AHB2 peripheral clocks enable in Sleep and Stop modes register"]
# [inline (always)]
pub const fn c2ahb2smenr (self) -> crate :: common :: Reg < regs :: C2ahb2smenr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (364usize) as _) } } # [doc = "CPU2 AHB3 peripheral clocks enable in Sleep and Stop modes register"]
# [inline (always)]
pub const fn c2ahb3smenr (self) -> crate :: common :: Reg < regs :: C2ahb3smenr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (368usize) as _) } } # [doc = "CPU2 APB1SMENR1"]
# [inline (always)]
pub const fn c2apb1smenr1 (self) -> crate :: common :: Reg < regs :: C2apb1smenr1 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (376usize) as _) } } # [doc = "CPU2 APB1 peripheral clocks enable in Sleep and Stop modes register 2"]
# [inline (always)]
pub const fn c2apb1smenr2 (self) -> crate :: common :: Reg < regs :: C2apb1smenr2 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (380usize) as _) } } # [doc = "CPU2 APB2SMENR"]
# [inline (always)]
pub const fn c2apb2smenr (self) -> crate :: common :: Reg < regs :: C2apb2smenr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (384usize) as _) } } # [doc = "CPU2 APB3SMENR"]
# [inline (always)]
...
DISABLE = 0 , PLLSAI1_R = 0x01 , PLL1_P = 0x02 , # [doc = "SYSCLK clock selected"]
...
CLK48 = 0 , # [doc = "LSI clock selected"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Sai1sel { PLLSAI1_P = 0 , PLL1_P = 0x01 , HSI = 0x02 , SAI1_EXTCLK = 0x03 , } impl Sai1sel { # [inline (always)]
