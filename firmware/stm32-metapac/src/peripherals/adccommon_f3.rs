...
# [inline (always)]
pub const fn csr (self) -> crate :: common :: Reg < regs :: Csr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0usize) as _) } } # [doc = "ADC common control register"]
# [inline (always)]
pub const fn ccr (self) -> crate :: common :: Reg < regs :: Ccr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize) as _) } } # [doc = "ADC common regular data register for dual and triple modes"]
# [inline (always)]
pub const fn cdr (self) -> crate :: common :: Reg < regs :: Cdr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (12usize) as _) } } } pub mod regs { # [doc = "ADC common control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub const fn dmacfg (& self) -> super :: vals :: Dmacfg { let val = (self . 0 >> 13usize) & 0x01 ; super :: vals :: Dmacfg :: from_bits (val as u8) } # [doc = "DMA configuration (for multi-ADC mode)"]
# [inline (always)]
...
ASYNCHRONOUS = 0 , # [doc = "Use AHB clock rcc_hclk3. In this case rcc_hclk must equal sys_d1cpre_ck."]
...
fn from (val : Ckmode) -> u8 { Ckmode :: to_bits (val) } } # [doc = "DMA configuration (for multi-ADC mode)"]
# [repr (u8)]
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Dmacfg { # [doc = "DMA one shot mode selected"]
ONESHOT = 0 , # [doc = "DMA circular mode selected"]
...
INDEPENDENT = 0 , # [doc = "Dual, combined regular simultaneous + injected simultaneous mode"]
...
DISABLED = 0 , _RESERVED_1 = 0x01 , # [doc = "MDMA mode enabled for 12 and 10-bit resolution"]
BITS12_10 = 0x02 , # [doc = "MDMA mode enabled for 8 and 6-bit resolution"]
BIT8_6 = 0x03 , } impl Mdma { # [inline (always)]
