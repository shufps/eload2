...
# [inline (always)]
pub const fn ethernet_mac (self) -> EthernetMac { unsafe { EthernetMac :: from_ptr (self . ptr . add (0usize) as _) } } # [doc = "Ethernet: Precision Time Protocol (PTP)"]
# [inline (always)]
pub const fn ethernet_ptp (self) -> EthernetPtp { unsafe { EthernetPtp :: from_ptr (self . ptr . add (1792usize) as _) } } # [doc = "Ethernet: DMA mode register (DMA)"]
# [inline (always)]
pub const fn ethernet_dma (self) -> EthernetDma { unsafe { EthernetDma :: from_ptr (self . ptr . add (4096usize) as _) } } } # [doc = "Ethernet: DMA controller operation"]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub const fn dmabmr (self) -> crate :: common :: Reg < regs :: Dmabmr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0usize) as _) } } # [doc = "Ethernet DMA transmit poll demand register"]
# [inline (always)]
pub const fn dmatpdr (self) -> crate :: common :: Reg < regs :: Dmatpdr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (4usize) as _) } } # [doc = "EHERNET DMA receive poll demand register"]
# [inline (always)]
pub const fn dmarpdr (self) -> crate :: common :: Reg < regs :: Dmarpdr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize) as _) } } # [doc = "Ethernet DMA receive descriptor list address register"]
# [inline (always)]
pub const fn dmardlar (self) -> crate :: common :: Reg < regs :: Dmardlar , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (12usize) as _) } } # [doc = "Ethernet DMA transmit descriptor list address register"]
# [inline (always)]
pub const fn dmatdlar (self) -> crate :: common :: Reg < regs :: Dmatdlar , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (16usize) as _) } } # [doc = "Ethernet DMA status register"]
# [inline (always)]
pub const fn dmasr (self) -> crate :: common :: Reg < regs :: Dmasr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (20usize) as _) } } # [doc = "Ethernet DMA operation mode register"]
# [inline (always)]
pub const fn dmaomr (self) -> crate :: common :: Reg < regs :: Dmaomr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (24usize) as _) } } # [doc = "Ethernet DMA interrupt enable register"]
# [inline (always)]
pub const fn dmaier (self) -> crate :: common :: Reg < regs :: Dmaier , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (28usize) as _) } } # [doc = "Ethernet DMA missed frame and buffer overflow counter register"]
# [inline (always)]
pub const fn dmamfbocr (self) -> crate :: common :: Reg < regs :: Dmamfbocr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (32usize) as _) } } # [doc = "Ethernet DMA receive status watchdog timer register"]
# [inline (always)]
pub const fn dmarswtr (self) -> crate :: common :: Reg < regs :: Dmarswtr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (36usize) as _) } } # [doc = "Ethernet DMA current host transmit descriptor register"]
# [inline (always)]
pub const fn dmachtdr (self) -> crate :: common :: Reg < regs :: Dmachtdr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (72usize) as _) } } # [doc = "Ethernet DMA current host receive descriptor register"]
# [inline (always)]
pub const fn dmachrdr (self) -> crate :: common :: Reg < regs :: Dmachrdr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (76usize) as _) } } # [doc = "Ethernet DMA current host transmit buffer address register"]
# [inline (always)]
pub const fn dmachtbar (self) -> crate :: common :: Reg < regs :: Dmachtbar , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (80usize) as _) } } # [doc = "Ethernet DMA current host receive buffer address register"]
# [inline (always)]
pub const fn dmachrbar (self) -> crate :: common :: Reg < regs :: Dmachrbar , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (84usize) as _) } } } # [doc = "Ethernet: media access control (MAC)"]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub const fn maccr (self) -> crate :: common :: Reg < regs :: Maccr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0usize) as _) } } # [doc = "Ethernet MAC frame filter register"]
# [inline (always)]
pub const fn macffr (self) -> crate :: common :: Reg < regs :: Macffr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (4usize) as _) } } # [doc = "Ethernet MAC hash table high register"]
# [inline (always)]
pub const fn machthr (self) -> crate :: common :: Reg < regs :: Machthr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize) as _) } } # [doc = "Ethernet MAC hash table low register"]
# [inline (always)]
pub const fn machtlr (self) -> crate :: common :: Reg < regs :: Machtlr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (12usize) as _) } } # [doc = "Ethernet MAC MII address register"]
# [inline (always)]
pub const fn macmiiar (self) -> crate :: common :: Reg < regs :: Macmiiar , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (16usize) as _) } } # [doc = "Ethernet MAC MII data register"]
# [inline (always)]
pub const fn macmiidr (self) -> crate :: common :: Reg < regs :: Macmiidr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (20usize) as _) } } # [doc = "Ethernet MAC flow control register"]
# [inline (always)]
pub const fn macfcr (self) -> crate :: common :: Reg < regs :: Macfcr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (24usize) as _) } } # [doc = "Ethernet MAC VLAN tag register"]
# [inline (always)]
pub const fn macvlantr (self) -> crate :: common :: Reg < regs :: Macvlantr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (28usize) as _) } } # [doc = "Ethernet MAC remote wakeup frame filter register"]
# [inline (always)]
pub const fn macrwuffr (self) -> crate :: common :: Reg < u32 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (40usize) as _) } } # [doc = "Ethernet MAC PMT control and status register"]
# [inline (always)]
pub const fn macpmtcsr (self) -> crate :: common :: Reg < regs :: Macpmtcsr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (44usize) as _) } } # [doc = "Ethernet MAC debug register"]
# [inline (always)]
pub const fn macdbgr (self) -> crate :: common :: Reg < regs :: Macdbgr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (52usize) as _) } } # [doc = "Ethernet MAC interrupt status register"]
# [inline (always)]
pub const fn macsr (self) -> crate :: common :: Reg < regs :: Macsr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (56usize) as _) } } # [doc = "Ethernet MAC interrupt mask register"]
# [inline (always)]
pub const fn macimr (self) -> crate :: common :: Reg < regs :: Macimr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (60usize) as _) } } # [doc = "Ethernet MAC address 0 high register"]
# [inline (always)]
pub const fn maca0hr (self) -> crate :: common :: Reg < regs :: Maca0hr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (64usize) as _) } } # [doc = "Ethernet MAC address 0 low register"]
# [inline (always)]
pub const fn maca0lr (self) -> crate :: common :: Reg < regs :: Maca0lr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (68usize) as _) } } # [doc = "Ethernet MAC address 1/2/3 high register"]
# [inline (always)]
pub const fn macahr (self , n : usize) -> crate :: common :: Reg < regs :: Macahr , crate :: common :: RW > { assert ! (n < 3usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (72usize + n * 8usize) as _) } } # [doc = "Ethernet MAC address 1/2/3 low register"]
# [inline (always)]
pub const fn macalr (self , n : usize) -> crate :: common :: Reg < regs :: Macalr , crate :: common :: RW > { assert ! (n < 3usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (76usize + n * 8usize) as _) } } # [doc = "Ethernet MMC control register"]
# [inline (always)]
pub const fn mmccr (self) -> crate :: common :: Reg < regs :: Mmccr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (256usize) as _) } } # [doc = "Ethernet MMC receive interrupt register"]
# [inline (always)]
pub const fn mmcrir (self) -> crate :: common :: Reg < regs :: Mmcrir , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (260usize) as _) } } # [doc = "Ethernet MMC transmit interrupt register"]
# [inline (always)]
pub const fn mmctir (self) -> crate :: common :: Reg < regs :: Mmctir , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (264usize) as _) } } # [doc = "Ethernet MMC receive interrupt mask register"]
# [inline (always)]
pub const fn mmcrimr (self) -> crate :: common :: Reg < regs :: Mmcrimr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (268usize) as _) } } # [doc = "Ethernet MMC transmit interrupt mask register"]
# [inline (always)]
pub const fn mmctimr (self) -> crate :: common :: Reg < regs :: Mmctimr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (272usize) as _) } } # [doc = "Ethernet MMC transmitted good frames after a single collision counter"]
# [inline (always)]
pub const fn mmctgfsccr (self) -> crate :: common :: Reg < regs :: Mmctgfsccr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (332usize) as _) } } # [doc = "Ethernet MMC transmitted good frames after more than a single collision"]
# [inline (always)]
pub const fn mmctgfmsccr (self) -> crate :: common :: Reg < regs :: Mmctgfmsccr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (336usize) as _) } } # [doc = "Ethernet MMC transmitted good frames counter register"]
# [inline (always)]
pub const fn mmctgfcr (self) -> crate :: common :: Reg < regs :: Mmctgfcr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (360usize) as _) } } # [doc = "Ethernet MMC received frames with CRC error counter register"]
# [inline (always)]
pub const fn mmcrfcecr (self) -> crate :: common :: Reg < regs :: Mmcrfcecr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (404usize) as _) } } # [doc = "Ethernet MMC received frames with alignment error counter register"]
# [inline (always)]
pub const fn mmcrfaecr (self) -> crate :: common :: Reg < regs :: Mmcrfaecr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (408usize) as _) } } # [doc = "MMC received good unicast frames counter register"]
# [inline (always)]
pub const fn mmcrgufcr (self) -> crate :: common :: Reg < regs :: Mmcrgufcr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (452usize) as _) } } } # [doc = "Ethernet: Precision time protocol"]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub const fn ptptscr (self) -> crate :: common :: Reg < regs :: Ptptscr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0usize) as _) } } # [doc = "Ethernet PTP subsecond increment register"]
# [inline (always)]
pub const fn ptpssir (self) -> crate :: common :: Reg < regs :: Ptpssir , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (4usize) as _) } } # [doc = "Ethernet PTP time stamp high register"]
# [inline (always)]
pub const fn ptptshr (self) -> crate :: common :: Reg < regs :: Ptptshr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize) as _) } } # [doc = "Ethernet PTP time stamp low register"]
# [inline (always)]
pub const fn ptptslr (self) -> crate :: common :: Reg < regs :: Ptptslr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (12usize) as _) } } # [doc = "Ethernet PTP time stamp high update register"]
# [inline (always)]
pub const fn ptptshur (self) -> crate :: common :: Reg < regs :: Ptptshur , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (16usize) as _) } } # [doc = "Ethernet PTP time stamp low update register"]
# [inline (always)]
pub const fn ptptslur (self) -> crate :: common :: Reg < regs :: Ptptslur , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (20usize) as _) } } # [doc = "Ethernet PTP time stamp addend register"]
# [inline (always)]
pub const fn ptptsar (self) -> crate :: common :: Reg < regs :: Ptptsar , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (24usize) as _) } } # [doc = "Ethernet PTP target time high register"]
# [inline (always)]
pub const fn ptptthr (self) -> crate :: common :: Reg < regs :: Ptptthr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (28usize) as _) } } # [doc = "Ethernet PTP target time low register"]
# [inline (always)]
pub const fn ptpttlr (self) -> crate :: common :: Reg < regs :: Ptpttlr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (32usize) as _) } } # [doc = "Ethernet PTP time stamp status register"]
# [inline (always)]
pub const fn ptptssr (self) -> crate :: common :: Reg < regs :: Ptptssr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (40usize) as _) } } # [doc = "Ethernet PTP PPS control register"]
# [inline (always)]
pub const fn ptpppscr (self) -> crate :: common :: Reg < regs :: Ptpppscr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (44usize) as _) } } } pub mod regs { # [doc = "Ethernet DMA bus mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
DISABLED = 0 , # [doc = "MAC strips the Pad/FCS field on incoming frames only for lengths less than or equal to 1500 bytes"]
...
ENABLED = 0 , # [doc = "Address filters filter all incoming broadcast frames"]
...
BL10 = 0 , # [doc = "For retransmission n, wait up to 2^min(n, 8) time slots"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum CounterReset { _RESERVED_0 = 0 , # [doc = "Reset all counters. Cleared automatically"]
...
CR_60_100 = 0 , # [doc = "100-150 MHz HCLK/62"]
...
ENABLED = 0 , # [doc = "No error generated due to loss of carrier"]
...
ROLLOVER = 0 , # [doc = "Counters do not roll over to zero after reaching the maximum value"]
...
ROUNDROBIN = 0 , # [doc = "Rx has priority over Tx"]
...
NORMAL = 0 , # [doc = "Address check block operates in inverse filtering mode for the DA address comparison"]
...
HALFDUPLEX = 0 , # [doc = "MAC operates in full-duplex mode"]
...
STOPPED = 0 , # [doc = "Reception is placed in the Running state"]
...
ENABLED = 0 , # [doc = "Do not drop frames that only have errors in the receive checksum offload engine"]
...
VARIABLE = 0 , # [doc = "AHB uses only fixed burst transfers"]
...
DISABLEBACKPRESSURE = 0 , # [doc = "In full duplex, initiate a Pause control frame. In half duplex, assert back pressure"]
...
DROP = 0 , # [doc = "All frames except runt error frames are forwarded to the DMA"]
...
X1 = 0 , # [doc = "PBL values multiplied by 4"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Ftf { _RESERVED_0 = 0 , # [doc = "Transmit FIFO controller logic is reset to its default values. Cleared automatically"]
...
DROP = 0 , # [doc = "Rx FIFO forwards undersized frames"]
...
PERFECT = 0 , # [doc = "MAC performs destination address filtering of received multicast frames according to the hash table"]
...
HASHONLY = 0 , # [doc = "If HM or HU is set, frames that match either the perfect filter or the hash filter are passed"]
...
PERFECT = 0 , # [doc = "MAC performs destination address filtering of received unicast frames according to the hash table"]
...
DISABLED = 0 , # [doc = "IPv4 checksums are checked in received frames"]
...
ENABLED = 0 , # [doc = "Jabber disabled, transmit frames up to 16384 bytes"]
...
NORMAL = 0 , # [doc = "MAC operates in loopback mode at the MII"]
...
DESTINATION = 0 , # [doc = "This address is used for comparison with SA fields of received frames"]
...
NORMAL = 0 , # [doc = "If FB is low, start all bursts greater than 16 with INCR (undefined burst)"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum MbProgress { _RESERVED_0 = 0 , # [doc = "This bit is set to 1 by the application to indicate that a read or write access is in progress"]
...
ALMOSTHALF = 0 , # [doc = "When MCP is set, MMC counters are preset to almost-full value 0xFFFF_FFF0"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Mcp { _RESERVED_0 = 0 , # [doc = "MMC counters will be preset to almost full or almost half. Cleared automatically"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Pbl { _RESERVED_0 = 0 , # [doc = "Maximum of 1 beat per DMA transaction"]
...
PREVENTALL = 0 , # [doc = "MAC forwards all control frames to application except Pause"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Pd { _RESERVED_0 = 0 , # [doc = "All received frames will be dropped. Cleared automatically when a magic packet or wakeup frame is received"]
...
PLT4 = 0 , # [doc = "Pause time minus 28 slot times"]
...
UNMASKED = 0 , # [doc = "PMT Status interrupt generation disabled"]
...
ONETOONE = 0 , # [doc = "RxDMA priority over TxDMA is 2:1"]
...
ENABLED = 0 , # [doc = "MAC attempts only 1 transmission"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Rdp { _RESERVED_0 = 0 , # [doc = "1 beat per RxDMA transaction"]
...
UNMASKED = 0 , # [doc = "Received-alignment-error counter half-full interrupt disabled"]
...
UNMASKED = 0 , # [doc = "Received-crc-error counter half-full interrupt disabled"]
...
UNMASKED = 0 , # [doc = "Received-good-unicast counter half-full interrupt disabled"]
...
ENABLED = 0 , # [doc = "MAC disables reception of frames in half-duplex mode"]
...
pub const POLL : Self = Self (0) ; } impl Rpd { pub const fn from_bits (val : u32) -> Rpd { Self (val & 0xffff_ffff) } pub const fn to_bits (self) -> u32 { self . 0 } } impl From < u32 > for Rpd { # [inline (always)]
...
STOPPED = 0 , # [doc = "Running, fetching receive transfer descriptor"]
...
CUTTHROUGH = 0 , # [doc = "Frames are read from Rx FIFO after complete frame has been written"]
...
NORMAL = 0 , # [doc = "Source address filter operation inverted"]
...
STOPPED = 0 , # [doc = "Transmission is placed in Running state"]
...
UNMASKED = 0 , # [doc = "Transmitted-good counter half-full interrupt disabled"]
...
UNMASKED = 0 , # [doc = "Transmitted-good-multiple-collision half-full interrupt disabled"]
...
UNMASKED = 0 , # [doc = "Transmitted-good-single-collision half-full interrupt disabled"]
...
pub const POLL : Self = Self (0) ; } impl Tpd { pub const fn from_bits (val : u32) -> Tpd { Self (val & 0xffff_ffff) } pub const fn to_bits (self) -> u32 { self . 0 } } impl From < u32 > for Tpd { # [inline (always)]
...
STOPPED = 0 , # [doc = "Running, fetching transmit transfer descriptor"]
...
CUTTHROUGH = 0 , # [doc = "Transmission starts when a full frame is in the Tx FIFO"]
...
UNMASKED = 0 , # [doc = "Time stamp interrupt generation disabled"]
...
COMBINED = 0 , # [doc = "RxDMA uses RDP value, TxDMA uses PBL value"]
...
VLANTC16 = 0 , # [doc = "12 bit VLAN identifies are used for comparison and filtering"]
...
ENABLED = 0 , # [doc = "Watchdog disabled, receive frames may be up to to 16384 bytes"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Wffrpr { _RESERVED_0 = 0 , # [doc = "Reset wakeup frame filter register point to 0b000. Automatically cleared"]
...
ENABLED = 0 , # [doc = "Automatic generation of zero-quanta pause control frames is disabled"]
