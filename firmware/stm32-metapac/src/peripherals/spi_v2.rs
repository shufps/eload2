...
# [inline (always)]
pub const fn cr2 (self) -> crate :: common :: Reg < regs :: Cr2 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (4usize) as _) } } # [doc = "status register"]
# [inline (always)]
pub const fn sr (self) -> crate :: common :: Reg < regs :: Sr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize) as _) } } # [doc = "data register"]
# [inline (always)]
pub const fn dr (self) -> crate :: common :: Reg < regs :: Dr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (12usize) as _) } } # [doc = "CRC polynomial register"]
# [inline (always)]
pub const fn crcpr (self) -> crate :: common :: Reg < regs :: Crcpr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (16usize) as _) } } # [doc = "RX CRC register"]
# [inline (always)]
pub const fn rxcrcr (self) -> crate :: common :: Reg < regs :: Rxcrcr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (20usize) as _) } } # [doc = "TX CRC register"]
# [inline (always)]
pub const fn txcrcr (self) -> crate :: common :: Reg < regs :: Txcrcr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (24usize) as _) } } # [doc = "I2S configuration register"]
# [inline (always)]
pub const fn i2scfgr (self) -> crate :: common :: Reg < regs :: I2scfgr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (28usize) as _) } } # [doc = "I2S prescaler register"]
# [inline (always)]
pub const fn i2spr (self) -> crate :: common :: Reg < regs :: I2spr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (32usize) as _) } } } pub mod regs { # [doc = "control register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
UNIDIRECTIONAL = 0 , # [doc = "1-line bidirectional data mode selected"]
...
RECEIVE = 0 , # [doc = "Output enabled (transmit-only mode)"]
...
SIXTEENBIT = 0 , # [doc = "32-bit wide"]
THIRTYTWOBIT = 0x01 , } impl Chlen { # [inline (always)]
...
LEFT = 0 , # [doc = "Channel right has to be transmitted or has been received"]
...
IDLELOW = 0 , # [doc = "I2S clock inactive state is high level"]
...
EIGHTBIT = 0 , # [doc = "16-bit CRC length"]
SIXTEENBIT = 0x01 , } impl Crcl { # [inline (always)]
...
TXBUFFER = 0 , # [doc = "Next transmit value is from Tx CRC register"]
...
SIXTEENBIT = 0 , # [doc = "24-bit data length"]
TWENTYFOURBIT = 0x01 , # [doc = "32-bit data length"]
THIRTYTWOBIT = 0x02 , _RESERVED_3 = 0x03 , } impl Datlen { # [inline (always)]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Ds { _RESERVED_0 = 0 , _RESERVED_1 = 0x01 , _RESERVED_2 = 0x02 , # [doc = "4-bit"]
FOURBIT = 0x03 , # [doc = "5-bit"]
FIVEBIT = 0x04 , # [doc = "6-bit"]
SIXBIT = 0x05 , # [doc = "7-bit"]
SEVENBIT = 0x06 , # [doc = "8-bit"]
EIGHTBIT = 0x07 , # [doc = "9-bit"]
NINEBIT = 0x08 , # [doc = "10-bit"]
TENBIT = 0x09 , # [doc = "11-bit"]
ELEVENBIT = 0x0a , # [doc = "12-bit"]
TWELVEBIT = 0x0b , # [doc = "13-bit"]
THIRTEENBIT = 0x0c , # [doc = "14-bit"]
FOURTEENBIT = 0x0d , # [doc = "15-bit"]
FIFTEENBIT = 0x0e , # [doc = "16-bit"]
SIXTEENBIT = 0x0f , } impl Ds { # [inline (always)]
...
HALF = 0 , # [doc = "RXNE event is generated if the FIFO level is greater than or equal to 1/4 (8-bit)"]
...
SPIMODE = 0 , # [doc = "I2S mode is selected"]
...
PHILIPS = 0 , # [doc = "MSB justified standard"]
...
EVEN = 0 , # [doc = "Number of data to transfer for receive is odd"]
...
EVEN = 0 , # [doc = "Number of data to transfer for transmit is odd"]
...
EVEN = 0 , # [doc = "Real divider value is (I2SDIV * 2) + 1"]
...
SHORT = 0 , # [doc = "Long frame synchronisation"]
...
FULLDUPLEX = 0 , # [doc = "Output disabled (Receive-only mode)"]
