...
# [inline (always)]
pub const fn fmpi2c1sel (& self) -> super :: vals :: Fmpicsel { let val = (self . 0 >> 22usize) & 0x03 ; super :: vals :: Fmpicsel :: from_bits (val as u8) } # [doc = "FMPI2C1 kernel clock source selection"]
# [inline (always)]
pub fn set_fmpi2c1sel (& mut self , val : super :: vals :: Fmpicsel) { self . 0 = (self . 0 & ! (0x03 << 22usize)) | (((val . to_bits () as u32) & 0x03) << 22usize) ; } # [doc = "HDMI CEC clock source selection"]
# [inline (always)]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Fmpicsel { # [doc = "APB clock selected as I2C clock"]
PCLK1 = 0 , # [doc = "System clock selected as I2C clock"]
SYS = 0x01 , # [doc = "HSI clock selected as I2C clock"]
HSI = 0x02 , _RESERVED_3 = 0x03 , } impl Fmpicsel { # [inline (always)]
pub const fn from_bits (val : u8) -> Fmpicsel { unsafe { core :: mem :: transmute (val & 0x03) } } # [inline (always)]
pub const fn to_bits (self) -> u8 { unsafe { core :: mem :: transmute (self) } } } impl From < u8 > for Fmpicsel { # [inline (always)]
fn from (val : u8) -> Fmpicsel { Fmpicsel :: from_bits (val) } } impl From < Fmpicsel > for u8 { # [inline (always)]
fn from (val : Fmpicsel) -> u8 { Fmpicsel :: to_bits (val) } } # [repr (u8)]
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
