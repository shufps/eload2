...
# [inline (always)]
pub const fn ccr (self) -> crate :: common :: Reg < regs :: Ccr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (4usize) as _) } } # [doc = "ADC common regular data register for dual and triple modes"]
# [inline (always)]
pub const fn cdr (self) -> crate :: common :: Reg < regs :: Cdr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize) as _) } } } pub mod regs { # [doc = "ADC common control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
SINGLE = 0 , # [doc = "DMA requests are issued as long as data are converted and DMA=01, 10 or 11"]
...
DISABLED = 0 , # [doc = "DMA mode 1 enabled (2 / 3 half-words one by one - 1 then 2 then 3)"]
...
INDEPENDENT = 0 , # [doc = "Dual ADC1 and ADC2, combined regular and injected simultaneous mode"]
