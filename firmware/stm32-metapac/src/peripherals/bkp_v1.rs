...
# [inline (always)]
pub const fn dr (self , n : usize) -> crate :: common :: Reg < regs :: Dr , crate :: common :: RW > { assert ! (n < 42usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0usize + ([0usize , 4usize , 8usize , 12usize , 16usize , 20usize , 24usize , 28usize , 32usize , 36usize , 60usize , 64usize , 68usize , 72usize , 76usize , 80usize , 84usize , 88usize , 92usize , 96usize , 100usize , 104usize , 108usize , 112usize , 116usize , 120usize , 124usize , 128usize , 132usize , 136usize , 140usize , 144usize , 148usize , 152usize , 156usize , 160usize , 164usize , 168usize , 172usize , 176usize , 180usize , 184usize]
[n]
as usize)) as _) } } # [doc = "RTC clock calibration register"]
# [inline (always)]
pub const fn rtccr (self) -> crate :: common :: Reg < regs :: Rtccr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (40usize) as _) } } # [doc = "Control register"]
# [inline (always)]
pub const fn cr (self) -> crate :: common :: Reg < regs :: Cr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (44usize) as _) } } # [doc = "Control/status register"]
# [inline (always)]
pub const fn csr (self) -> crate :: common :: Reg < regs :: Csr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (48usize) as _) } } } pub mod regs { # [doc = "Control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
ALARM = 0 , # [doc = "RTC Second pulse output selected"]
...
HIGH = 0 , # [doc = "A low level on the TAMPER pin resets all data backup registers (if TPE bit is set)"]
