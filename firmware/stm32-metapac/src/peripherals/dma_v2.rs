...
# [inline (always)]
pub const fn isr (self , n : usize) -> crate :: common :: Reg < regs :: Ixr , crate :: common :: R > { assert ! (n < 2usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0usize + n * 4usize) as _) } } # [doc = "low interrupt flag clear register"]
# [inline (always)]
pub const fn ifcr (self , n : usize) -> crate :: common :: Reg < regs :: Ixr , crate :: common :: W > { assert ! (n < 2usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize + n * 4usize) as _) } } # [doc = "Stream cluster: S?CR, S?NDTR, S?M0AR, S?M1AR and S?FCR registers"]
# [inline (always)]
pub const fn st (self , n : usize) -> St { assert ! (n < 8usize) ; unsafe { St :: from_ptr (self . ptr . add (16usize + n * 24usize) as _) } } } # [doc = "Stream cluster: S?CR, S?NDTR, S?M0AR, S?M1AR and S?FCR registers"]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub const fn cr (self) -> crate :: common :: Reg < regs :: Cr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0usize) as _) } } # [doc = "stream x number of data register"]
# [inline (always)]
pub const fn ndtr (self) -> crate :: common :: Reg < regs :: Ndtr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (4usize) as _) } } # [doc = "stream x peripheral address register"]
# [inline (always)]
pub const fn par (self) -> crate :: common :: Reg < u32 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize) as _) } } # [doc = "stream x memory 0 address register"]
# [inline (always)]
pub const fn m0ar (self) -> crate :: common :: Reg < u32 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (12usize) as _) } } # [doc = "stream x memory 1 address register"]
# [inline (always)]
pub const fn m1ar (self) -> crate :: common :: Reg < u32 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (16usize) as _) } } # [doc = "stream x FIFO control register"]
# [inline (always)]
pub const fn fcr (self) -> crate :: common :: Reg < regs :: Fcr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (20usize) as _) } } } pub mod regs { # [doc = "stream x configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
SINGLE = 0 , # [doc = "Incremental burst of 4 beats"]
...
MEMORY0 = 0 , # [doc = "The current target memory is Memory 1"]
...
PERIPHERALTOMEMORY = 0 , # [doc = "Memory-to-peripheral"]
...
ENABLED = 0 , # [doc = "Direct mode is disabled"]
...
QUARTER1 = 0 , # [doc = "1/4 <= fifo_level < 1/2"]
...
DMA = 0 , # [doc = "The peripheral is the flow controller"]
...
PSIZE = 0 , # [doc = "The offset size for the peripheral address calculation is fixed to 4 (32-bit alignment)"]
