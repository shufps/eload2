...
# [inline (always)]
pub const fn smpr2 (self) -> crate :: common :: Reg < regs :: Smpr2 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (16usize) as _) } } # [doc = "injected channel data offset register x"]
# [inline (always)]
pub const fn jofr (self , n : usize) -> crate :: common :: Reg < regs :: Jofr , crate :: common :: RW > { assert ! (n < 4usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (20usize + n * 4usize) as _) } } # [doc = "watchdog higher threshold register"]
# [inline (always)]
...
# [inline (always)]
pub const fn jsqr (self) -> crate :: common :: Reg < regs :: Jsqr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (56usize) as _) } } # [doc = "injected data register x"]
# [inline (always)]
pub const fn jdr (self , n : usize) -> crate :: common :: Reg < regs :: Jdr , crate :: common :: R > { assert ! (n < 4usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (60usize + n * 4usize) as _) } } # [doc = "regular data register"]
# [inline (always)]
...
ALLCHANNELS = 0 , # [doc = "Analog watchdog enabled on a single channel"]
...
SINGLE = 0 , # [doc = "Continuous conversion mode"]
...
SINGLE = 0 , # [doc = "DMA requests are issued as long as data are converted and DMA=1"]
...
EACHSEQUENCE = 0 , # [doc = "The EOC bit is set at the end of each regular conversion"]
...
TWELVEBIT = 0 , # [doc = "10-bit (13 ADCCLK cycles)"]
TENBIT = 0x01 , # [doc = "8-bit (11 ADCCLK cycles)"]
EIGHTBIT = 0x02 , # [doc = "6-bit (9 ADCCLK cycles)"]
