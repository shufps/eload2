...
# [inline (always)]
pub const fn csr (self) -> crate :: common :: Reg < regs :: Csr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (36usize) as _) } } # [doc = "AHB peripheral clock reset register (RCC_AHBRSTR)"]
# [inline (always)]
...
# [inline (always)]
pub const fn cfgr2 (self) -> crate :: common :: Reg < regs :: Cfgr2 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (44usize) as _) } } } pub mod regs { # [doc = "AHB Peripheral Clock enable register (RCC_AHBENR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
SYS = 0 , # [doc = "PLL3 VCO clock selected as I2S clock entry"]
...
NOMCO = 0 , _RESERVED_1 = 0x01 , _RESERVED_2 = 0x02 , _RESERVED_3 = 0x03 , # [doc = "System clock selected"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Pll2mul { _RESERVED_0 = 0 , _RESERVED_1 = 0x01 , _RESERVED_2 = 0x02 , _RESERVED_3 = 0x03 , _RESERVED_4 = 0x04 , _RESERVED_5 = 0x05 , # [doc = "PLL clock entry x8"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Pllmul { _RESERVED_0 = 0 , _RESERVED_1 = 0x01 , # [doc = "PLL input clock x4"]
...
HSI_DIV2 = 0 , # [doc = "HSE divided by PREDIV selected as PLL input clock"]
...
HSE = 0 , # [doc = "PLL2 selected as PREDIV1 clock entry"]
