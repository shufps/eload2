...
# [inline (always)]
pub const fn tr (self) -> crate :: common :: Reg < regs :: Tr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0usize) as _) } } # [doc = "Date register"]
# [inline (always)]
pub const fn dr (self) -> crate :: common :: Reg < regs :: Dr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (4usize) as _) } } # [doc = "Sub second register"]
# [inline (always)]
pub const fn ssr (self) -> crate :: common :: Reg < regs :: Ssr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize) as _) } } # [doc = "Initialization control and status register"]
# [inline (always)]
pub const fn icsr (self) -> crate :: common :: Reg < regs :: Icsr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (12usize) as _) } } # [doc = "Prescaler register"]
# [inline (always)]
pub const fn prer (self) -> crate :: common :: Reg < regs :: Prer , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (16usize) as _) } } # [doc = "Wakeup timer register"]
# [inline (always)]
pub const fn wutr (self) -> crate :: common :: Reg < regs :: Wutr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (20usize) as _) } } # [doc = "Control register"]
# [inline (always)]
pub const fn cr (self) -> crate :: common :: Reg < regs :: Cr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (24usize) as _) } } # [doc = "Privilege mode control register"]
# [inline (always)]
pub const fn privcr (self) -> crate :: common :: Reg < regs :: Privcr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (28usize) as _) } } # [doc = "Secure mode control register"]
# [inline (always)]
pub const fn seccfgr (self) -> crate :: common :: Reg < regs :: Seccfgr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (32usize) as _) } } # [doc = "Write protection register"]
# [inline (always)]
pub const fn wpr (self) -> crate :: common :: Reg < regs :: Wpr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (36usize) as _) } } # [doc = "Calibration register"]
# [inline (always)]
pub const fn calr (self) -> crate :: common :: Reg < regs :: Calr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (40usize) as _) } } # [doc = "Shift control register"]
# [inline (always)]
pub const fn shiftr (self) -> crate :: common :: Reg < regs :: Shiftr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (44usize) as _) } } # [doc = "Timestamp time register"]
# [inline (always)]
pub const fn tstr (self) -> crate :: common :: Reg < regs :: Tstr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (48usize) as _) } } # [doc = "Timestamp date register"]
# [inline (always)]
pub const fn tsdr (self) -> crate :: common :: Reg < regs :: Tsdr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (52usize) as _) } } # [doc = "Timestamp sub second register"]
# [inline (always)]
pub const fn tsssr (self) -> crate :: common :: Reg < regs :: Tsssr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (56usize) as _) } } # [doc = "Alarm register"]
# [inline (always)]
pub const fn alrmr (self , n : usize) -> crate :: common :: Reg < regs :: Alrmr , crate :: common :: RW > { assert ! (n < 2usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (64usize + n * 8usize) as _) } } # [doc = "Alarm sub second register"]
# [inline (always)]
pub const fn alrmssr (self , n : usize) -> crate :: common :: Reg < regs :: Alrmssr , crate :: common :: RW > { assert ! (n < 2usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (68usize + n * 8usize) as _) } } # [doc = "Status register"]
# [inline (always)]
pub const fn sr (self) -> crate :: common :: Reg < regs :: Sr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (80usize) as _) } } # [doc = "Masked interrupt status register"]
# [inline (always)]
pub const fn misr (self) -> crate :: common :: Reg < regs :: Misr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (84usize) as _) } } # [doc = "Secure masked interrupt status register"]
# [inline (always)]
pub const fn smisr (self) -> crate :: common :: Reg < regs :: Smisr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (88usize) as _) } } # [doc = "Status clear register"]
# [inline (always)]
pub const fn scr (self) -> crate :: common :: Reg < regs :: Scr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (92usize) as _) } } # [doc = "Alarm binary mode register"]
# [inline (always)]
pub const fn alrbinr (self , n : usize) -> crate :: common :: Reg < regs :: Alrbinr , crate :: common :: RW > { assert ! (n < 2usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (112usize + n * 4usize) as _) } } } pub mod regs { # [doc = "RTC alarm A binary mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
pub enum Alrf { _RESERVED_0 = 0 , # [doc = "This flag is set by hardware when the time/date registers (RTC_TR and RTC_DR) match the Alarm A register (RTC_ALRMAR)"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Alrmf { _RESERVED_0 = 0 , # [doc = "This flag is set by hardware when the time/date registers (RTC_TR and RTC_DR) match the Alarm A register (RTC_ALRMAR)"]
...
TOMATCH = 0 , # [doc = "Date/day don’t care in Alarm comparison"]
...
FREERUNNING = 0 , # [doc = "The synchronous binary counter (SS\\[31:0\\]
...
BIT7 = 0 , # [doc = "1s increment each time SS\\[8:0\\]=0"]
...
BCD = 0 , # [doc = "Free running Binary mode (BCD mode disabled)"]
...
NOCHANGE = 0 , # [doc = "One RTCCLK pulse is effectively inserted every 2^11 pulses (frequency increased by 488.5 ppm)"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Calrf { _RESERVED_0 = 0 , # [doc = "Clear interrupt flag by writing 1"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Calw16 { _RESERVED_0 = 0 , # [doc = "When CALW16 is set to ‘1’, the 16-second calibration cycle period is selected.This bit must not be set to ‘1’ if CALW8=1"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Calw8 { _RESERVED_0 = 0 , # [doc = "When CALW8 is set to ‘1’, the 8-second calibration cycle period is selected"]
...
CALFREQ_512HZ = 0 , # [doc = "Calibration output is 1 Hz (with default prescaler setting)"]
...
TWENTYFOURHOUR = 0 , # [doc = "AM/PM hour format"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Itsf { _RESERVED_0 = 0 , # [doc = "This flag is set by hardware when a timestamp on the internal event occurs"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Itsmf { _RESERVED_0 = 0 , # [doc = "This flag is set by hardware when a timestamp on the internal event occurs"]
...
pub const ACTIVATE : Self = Self (0) ; # [doc = "Key 2"]
...
RTCCLK = 0 , # [doc = "Calibration window is 220 ck_apre, which is the required configuration for ultra-low consumption mode"]
...
DISABLED = 0 , # [doc = "Alarm A output enabled"]
...
HIGH = 0 , # [doc = "The pin is low when ALRAF/ALRBF/WUTF is asserted (depending on OSEL\\[1:0\\])"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Recalpf { _RESERVED_0 = 0 , # [doc = "The RECALPF status flag is automatically set to 1 when software writes to the RTC_CALR register, indicating that the RTC_CALR register is blocked. When the new calibration settings are taken into account, this bit returns to 0"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Ssruf { _RESERVED_0 = 0 , # [doc = "This flag is set by hardware when the SSR rolls under 0. SSRUF is not set when SSCLR=1"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Ssrumf { _RESERVED_0 = 0 , # [doc = "This flag is set by hardware when the SSR rolls under 0. SSRUF is not set when SSCLR=1"]
...
PUSHPULL = 0 , # [doc = "TAMPALRM is open-drain output"]
...
RISINGEDGE = 0 , # [doc = "RTC_TS input falling edge generates a time-stamp event"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Tsf { _RESERVED_0 = 0 , # [doc = "This flag is set by hardware when a time-stamp event occurs"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Tsmf { _RESERVED_0 = 0 , # [doc = "This flag is set by hardware when a time-stamp event occurs"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Tsovf { _RESERVED_0 = 0 , # [doc = "This flag is set by hardware when a time-stamp event occurs while TSF is already set"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Tsovmf { _RESERVED_0 = 0 , # [doc = "This flag is set by hardware when a time-stamp event occurs while TSF is already set"]
...
DIV16 = 0 , # [doc = "RTC/8 clock is selected"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Wutf { _RESERVED_0 = 0 , # [doc = "This flag is set by hardware when the wakeup auto-reload counter reaches 0"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Wutmf { _RESERVED_0 = 0 , # [doc = "This flag is set by hardware when the wakeup auto-reload counter reaches 0"]
