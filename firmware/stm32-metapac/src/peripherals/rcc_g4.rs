...
# [inline (always)]
pub const fn ccipr2 (self) -> crate :: common :: Reg < regs :: Ccipr2 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (156usize) as _) } } } pub mod regs { # [doc = "AHB1 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
DISABLE = 0 , # [doc = "PLL 'P' clock selected as ADC clock"]
...
HSI48 = 0 , _RESERVED_1 = 0x01 , # [doc = "PLLQCLK selected as 48 MHz clock"]
...
HSE = 0 , # [doc = "PLLQCLK used as FDCAN clock source"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Sw { _RESERVED_0 = 0 , # [doc = "HSI selected as system clock"]
