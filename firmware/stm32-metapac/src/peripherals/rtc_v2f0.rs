...
# [inline (always)]
pub const fn alrmr (self , n : usize) -> crate :: common :: Reg < regs :: Alrmr , crate :: common :: RW > { assert ! (n < 1usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (28usize + n * 4usize) as _) } } # [doc = "Write protection register"]
# [inline (always)]
...
# [inline (always)]
pub const fn alrmssr (self , n : usize) -> crate :: common :: Reg < regs :: Alrmssr , crate :: common :: RW > { assert ! (n < 1usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (68usize + n * 4usize) as _) } } # [doc = "Backup register"]
# [inline (always)]
