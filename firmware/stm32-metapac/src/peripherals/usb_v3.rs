...
# [inline (always)]
pub const fn epr (self , n : usize) -> crate :: common :: Reg < regs :: Epr , crate :: common :: RW > { assert ! (n < 8usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0usize + n * 4usize) as _) } } # [doc = "control register"]
# [inline (always)]
pub const fn cntr (self) -> crate :: common :: Reg < regs :: Cntr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (64usize) as _) } } # [doc = "interrupt status register"]
# [inline (always)]
pub const fn istr (self) -> crate :: common :: Reg < regs :: Istr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (68usize) as _) } } # [doc = "frame number register"]
# [inline (always)]
pub const fn fnr (self) -> crate :: common :: Reg < regs :: Fnr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (72usize) as _) } } # [doc = "device address"]
# [inline (always)]
pub const fn daddr (self) -> crate :: common :: Reg < regs :: Daddr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (76usize) as _) } } # [doc = "Buffer table address"]
# [inline (always)]
pub const fn btable (self) -> crate :: common :: Reg < regs :: Btable , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (80usize) as _) } } # [doc = "LPM control and status register"]
# [inline (always)]
pub const fn lpmcsr (self) -> crate :: common :: Reg < regs :: Lpmcsr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (84usize) as _) } } # [doc = "Battery Charging Detector"]
# [inline (always)]
pub const fn bcdr (self) -> crate :: common :: Reg < regs :: Bcdr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (88usize) as _) } } } pub mod regs { # [doc = "Battery Charging Detector"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
TO = 0 , # [doc = "data received by the USB peripheral from the host PC"]
...
NYET = 0 , # [doc = "the valid LPM Token will be ACK"]
...
DISABLED = 0 , # [doc = "the endpoint is stalled and all requests result in a STALL handshake"]
