...
# [inline (always)]
pub const fn cfgr1 (self) -> crate :: common :: Reg < regs :: Cfgr1 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0usize) as _) } } # [doc = "CCM SRAM protection register"]
# [inline (always)]
pub const fn rcr (self) -> crate :: common :: Reg < regs :: Rcr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (4usize) as _) } } # [doc = "external interrupt configuration register"]
# [inline (always)]
pub const fn exticr (self , n : usize) -> crate :: common :: Reg < regs :: Exticr , crate :: common :: RW > { assert ! (n < 4usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize + n * 4usize) as _) } } # [doc = "configuration register 2"]
# [inline (always)]
pub const fn cfgr2 (self) -> crate :: common :: Reg < regs :: Cfgr2 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (24usize) as _) } } # [doc = "configuration register 4"]
# [inline (always)]
pub const fn cfgr4 (self) -> crate :: common :: Reg < regs :: Cfgr4 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (72usize) as _) } } # [doc = "configuration register 3"]
# [inline (always)]
pub const fn cfgr3 (self) -> crate :: common :: Reg < regs :: Cfgr3 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (80usize) as _) } } } pub mod regs { # [doc = "configuration register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
TIM6 = 0 , # [doc = "Trigger source is TIM20_CC2"]
...
TIM3 = 0 , # [doc = "Trigger source is TIM20_CC3"]
...
TIM1 = 0 , # [doc = "rigger source is TIM20_TRGO"]
...
TIM2 = 0 , # [doc = "rigger source is TIM20_TRGO2"]
...
TIM4 = 0 , # [doc = "Trigger source is TIM20_CC1"]
...
TIM3 = 0 , # [doc = "Trigger source is TIM20_CC4"]
...
TIM2 = 0 , # [doc = "Trigger source is TIM20_TRGO"]
...
EXTI15 = 0 , # [doc = "Trigger source is TIM20_TRGO2"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Adc2DmaRmpCfgr3 { _RESERVED_0 = 0 , _RESERVED_1 = 0x01 , # [doc = "ADC2 mapped on DMA1 channel 2"]
...
TIM2 = 0 , # [doc = "Trigger source is TIM20_CC1"]
...
EXTI2 = 0 , # [doc = "Trigger source is TIM20_TRGO"]
...
TIM4 = 0 , # [doc = "Trigger source is TIM20_TRGO2"]
...
TIM1 = 0 , # [doc = "Trigger source is TIM20_TRGO2"]
...
TIM7 = 0 , # [doc = "Trigger source is TIM20_CC2"]
...
TIM4 = 0 , # [doc = "Trigger source is TIM20_TRGO"]
...
TIM15 = 0 , # [doc = "DAC trigger is HRTIM1_DAC1_TRIG1"]
...
NOREDIRECTION = 0 , # [doc = "TIM2 IC1 and TIM2 IC2 are connected to TIM15 IC1 and TIM15 IC2 respectively"]
...
MAPDMA1CH7 = 0 , # [doc = "I2C1_RX mapped on DMA1 CH3"]
...
MAPDMA1CH6 = 0 , # [doc = "I2C1_TX mapped on DMA1 CH2"]
...
MAINFLASH = 0 , # [doc = "System Flash memory mapped at 0x0000_0000"]
...
MAPDMA1CH3 = 0 , # [doc = "SPI1_RX mapped on DMA1 CH4"]
...
MAPDMA1CH3 = 0 , # [doc = "SPI1_TX mapped on DMA1 CH5"]
