...
# [inline (always)]
pub const fn mem (self , n : usize) -> crate :: common :: Reg < u32 , crate :: common :: RW > { assert ! (n < 512usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0usize + n * 4usize) as _) } } }