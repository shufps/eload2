...
# [inline (always)]
pub const fn i2c1sel (& self) -> super :: vals :: Icsel { let val = (self . 0 >> 16usize) & 0x03 ; super :: vals :: Icsel :: from_bits (val as u8) } # [doc = "I2C1 clock source selection"]
# [inline (always)]
pub fn set_i2c1sel (& mut self , val : super :: vals :: Icsel) { self . 0 = (self . 0 & ! (0x03 << 16usize)) | (((val . to_bits () as u32) & 0x03) << 16usize) ; } # [doc = "I2C2 clock source selection"]
# [inline (always)]
pub const fn i2c2sel (& self) -> super :: vals :: Icsel { let val = (self . 0 >> 18usize) & 0x03 ; super :: vals :: Icsel :: from_bits (val as u8) } # [doc = "I2C2 clock source selection"]
# [inline (always)]
pub fn set_i2c2sel (& mut self , val : super :: vals :: Icsel) { self . 0 = (self . 0 & ! (0x03 << 18usize)) | (((val . to_bits () as u32) & 0x03) << 18usize) ; } # [doc = "I2C3 clock source selection"]
# [inline (always)]
pub const fn i2c3sel (& self) -> super :: vals :: Icsel { let val = (self . 0 >> 20usize) & 0x03 ; super :: vals :: Icsel :: from_bits (val as u8) } # [doc = "I2C3 clock source selection"]
# [inline (always)]
pub fn set_i2c3sel (& mut self , val : super :: vals :: Icsel) { self . 0 = (self . 0 & ! (0x03 << 20usize)) | (((val . to_bits () as u32) & 0x03) << 20usize) ; } # [doc = "I2C4 clock source selection"]
# [inline (always)]
pub const fn i2c4sel (& self) -> super :: vals :: Icsel { let val = (self . 0 >> 22usize) & 0x03 ; super :: vals :: Icsel :: from_bits (val as u8) } # [doc = "I2C4 clock source selection"]
# [inline (always)]
pub fn set_i2c4sel (& mut self , val : super :: vals :: Icsel) { self . 0 = (self . 0 & ! (0x03 << 22usize)) | (((val . to_bits () as u32) & 0x03) << 22usize) ; } # [doc = "Low power timer 1 clock source selection"]
# [inline (always)]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Icsel { # [doc = "APB clock selected as I2C clock"]
PCLK1 = 0 , # [doc = "System clock selected as I2C clock"]
SYS = 0x01 , # [doc = "HSI clock selected as I2C clock"]
HSI = 0x02 , _RESERVED_3 = 0x03 , } impl Icsel { # [inline (always)]
