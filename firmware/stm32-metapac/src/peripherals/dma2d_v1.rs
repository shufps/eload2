...
# [inline (always)]
pub const fn cr (self) -> crate :: common :: Reg < regs :: Cr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0usize) as _) } } # [doc = "Interrupt Status Register"]
# [inline (always)]
pub const fn isr (self) -> crate :: common :: Reg < regs :: Isr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (4usize) as _) } } # [doc = "interrupt flag clear register"]
# [inline (always)]
pub const fn ifcr (self) -> crate :: common :: Reg < regs :: Ifcr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize) as _) } } # [doc = "foreground memory address register"]
# [inline (always)]
pub const fn fgmar (self) -> crate :: common :: Reg < regs :: Fgmar , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (12usize) as _) } } # [doc = "foreground offset register"]
# [inline (always)]
pub const fn fgor (self) -> crate :: common :: Reg < regs :: Fgor , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (16usize) as _) } } # [doc = "background memory address register"]
# [inline (always)]
pub const fn bgmar (self) -> crate :: common :: Reg < regs :: Bgmar , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (20usize) as _) } } # [doc = "background offset register"]
# [inline (always)]
pub const fn bgor (self) -> crate :: common :: Reg < regs :: Bgor , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (24usize) as _) } } # [doc = "foreground PFC control register"]
# [inline (always)]
pub const fn fgpfccr (self) -> crate :: common :: Reg < regs :: Fgpfccr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (28usize) as _) } } # [doc = "foreground color register"]
# [inline (always)]
pub const fn fgcolr (self) -> crate :: common :: Reg < regs :: Fgcolr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (32usize) as _) } } # [doc = "background PFC control register"]
# [inline (always)]
pub const fn bgpfccr (self) -> crate :: common :: Reg < regs :: Bgpfccr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (36usize) as _) } } # [doc = "background color register"]
# [inline (always)]
pub const fn bgcolr (self) -> crate :: common :: Reg < regs :: Bgcolr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (40usize) as _) } } # [doc = "foreground CLUT memory address register"]
# [inline (always)]
pub const fn fgcmar (self) -> crate :: common :: Reg < regs :: Fgcmar , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (44usize) as _) } } # [doc = "background CLUT memory address register"]
# [inline (always)]
pub const fn bgcmar (self) -> crate :: common :: Reg < regs :: Bgcmar , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (48usize) as _) } } # [doc = "output PFC control register"]
# [inline (always)]
pub const fn opfccr (self) -> crate :: common :: Reg < regs :: Opfccr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (52usize) as _) } } # [doc = "output color register"]
# [inline (always)]
pub const fn ocolr (self) -> crate :: common :: Reg < regs :: Ocolr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (56usize) as _) } } # [doc = "output memory address register"]
# [inline (always)]
pub const fn omar (self) -> crate :: common :: Reg < regs :: Omar , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (60usize) as _) } } # [doc = "output offset register"]
# [inline (always)]
pub const fn oor (self) -> crate :: common :: Reg < regs :: Oor , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (64usize) as _) } } # [doc = "number of line register"]
# [inline (always)]
pub const fn nlr (self) -> crate :: common :: Reg < regs :: Nlr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (68usize) as _) } } # [doc = "line watermark register"]
# [inline (always)]
pub const fn lwr (self) -> crate :: common :: Reg < regs :: Lwr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (72usize) as _) } } # [doc = "AHB master timer configuration register"]
# [inline (always)]
pub const fn amtcr (self) -> crate :: common :: Reg < regs :: Amtcr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (76usize) as _) } } # [doc = "FGCLUT"]
# [inline (always)]
pub const fn fgclut (self) -> crate :: common :: Reg < regs :: Fgclut , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (1024usize) as _) } } # [doc = "BGCLUT"]
# [inline (always)]
pub const fn bgclut (self) -> crate :: common :: Reg < regs :: Bgclut , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (2048usize) as _) } } } pub mod regs { # [doc = "AHB master timer configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
pub enum Abort { _RESERVED_0 = 0 , # [doc = "Transfer abort requested"]
...
NOMODIFY = 0 , # [doc = "Replace with value in ALPHA\\[7:0\\]"]
...
ARGB8888 = 0 , # [doc = "CLUT color format RGB888"]
...
ARGB8888 = 0 , # [doc = "Color mode RGB888"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum BgpfccrStart { _RESERVED_0 = 0 , # [doc = "Start the automatic loading of the CLUT"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Caecif { _RESERVED_0 = 0 , # [doc = "Clear the CAEIF flag in the ISR register"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Cceif { _RESERVED_0 = 0 , # [doc = "Clear the CEIF flag in the ISR register"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Cctcif { _RESERVED_0 = 0 , # [doc = "Clear the CTCIF flag in the ISR register"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum CrStart { _RESERVED_0 = 0 , # [doc = "Launch the DMA2D"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Ctcif { _RESERVED_0 = 0 , # [doc = "Clear the TCIF flag in the ISR register"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Cteif { _RESERVED_0 = 0 , # [doc = "Clear the TEIF flag in the ISR register"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Ctwif { _RESERVED_0 = 0 , # [doc = "Clear the TWIF flag in the ISR register"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum FgpfccrStart { _RESERVED_0 = 0 , # [doc = "Start the automatic loading of the CLUT"]
...
MEMORYTOMEMORY = 0 , # [doc = "Memory-to-memory with PFC (FG fetch only with FG PFC active)"]
