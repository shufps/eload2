...
# [inline (always)]
pub const fn tim (self , n : usize) -> HrtimTimx { assert ! (n < 6usize) ; unsafe { HrtimTimx :: from_ptr (self . ptr . add (128usize + n * 128usize) as _) } } # [doc = "High Resolution Timer: Control Register 1"]
# [inline (always)]
