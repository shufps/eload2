...
# [inline (always)]
pub const fn mcr (self) -> crate :: common :: Reg < regs :: Mcr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0usize) as _) } } # [doc = "Master Timer Interrupt Status Register"]
# [inline (always)]
pub const fn misr (self) -> crate :: common :: Reg < regs :: Misr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (4usize) as _) } } # [doc = "Master Timer Interrupt Clear Register"]
# [inline (always)]
pub const fn micr (self) -> crate :: common :: Reg < regs :: Micr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize) as _) } } # [doc = "Master Timer DMA / Interrupt Enable Register"]
# [inline (always)]
pub const fn mdier (self) -> crate :: common :: Reg < regs :: Mdier , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (12usize) as _) } } # [doc = "Master Timer Counter Register"]
# [inline (always)]
pub const fn mcntr (self) -> crate :: common :: Reg < regs :: Mcntr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (16usize) as _) } } # [doc = "Master Timer Period Register"]
# [inline (always)]
pub const fn mper (self) -> crate :: common :: Reg < regs :: Mper , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (20usize) as _) } } # [doc = "Master Timer Repetition Register"]
# [inline (always)]
pub const fn mrep (self) -> crate :: common :: Reg < regs :: Mrep , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (24usize) as _) } } # [doc = "Master Timer Compare X Register"]
# [inline (always)]
pub const fn mcmp (self , n : usize) -> crate :: common :: Reg < regs :: Mcmpx , crate :: common :: RW > { assert ! (n < 4usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (28usize + ([0usize , 8usize , 12usize , 16usize]
[n]
as usize)) as _) } } # [doc = "High Resolution Timer: Timing Unit"]
# [inline (always)]
pub const fn tim (self , n : usize) -> HrtimTimx { assert ! (n < 5usize) ; unsafe { HrtimTimx :: from_ptr (self . ptr . add (128usize + n * 128usize) as _) } } # [doc = "High Resolution Timer: Control Register 1"]
# [inline (always)]
pub const fn cr1 (self) -> crate :: common :: Reg < regs :: HrtimCr1 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (896usize) as _) } } # [doc = "High Resolution Timer: Control Register 2"]
# [inline (always)]
pub const fn cr2 (self) -> crate :: common :: Reg < regs :: HrtimCr2 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (900usize) as _) } } # [doc = "High Resolution Timer: Interrupt Status Register"]
# [inline (always)]
pub const fn isr (self) -> crate :: common :: Reg < regs :: HrtimIsr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (904usize) as _) } } # [doc = "High Resolution Timer: Interrupt Clear Register"]
# [inline (always)]
pub const fn icr (self) -> crate :: common :: Reg < regs :: HrtimIcr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (908usize) as _) } } # [doc = "High Resolution Timer: Interrupt Enable Register"]
# [inline (always)]
pub const fn ier (self) -> crate :: common :: Reg < regs :: HrtimIer , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (912usize) as _) } } # [doc = "High Resolution Timer: Output Enable Register"]
# [inline (always)]
pub const fn oenr (self) -> crate :: common :: Reg < regs :: HrtimOenr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (916usize) as _) } } # [doc = "High Resolution Timer: Output Disable Register"]
# [inline (always)]
pub const fn odisr (self) -> crate :: common :: Reg < regs :: HrtimOdisr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (920usize) as _) } } # [doc = "High Resolution Timer: Output Disable Status Register"]
# [inline (always)]
pub const fn odsr (self) -> crate :: common :: Reg < regs :: HrtimOdsr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (924usize) as _) } } # [doc = "High Resolution Timer: Burst Mode Control Register"]
# [inline (always)]
pub const fn bmcr (self) -> crate :: common :: Reg < regs :: HrtimBmcr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (928usize) as _) } } # [doc = "High Resolution Timer: Burst Mode Trigger Register"]
# [inline (always)]
pub const fn bmtrgr (self) -> crate :: common :: Reg < regs :: HrtimBmtrgr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (932usize) as _) } } # [doc = "High Resolution Timer: Burst Mode Compare Register"]
# [inline (always)]
pub const fn bmcmpr (self) -> crate :: common :: Reg < regs :: HrtimBmcmpr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (936usize) as _) } } # [doc = "High Resolution Timer: Burst Mode Period Register"]
# [inline (always)]
pub const fn bmper (self) -> crate :: common :: Reg < regs :: HrtimBmper , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (940usize) as _) } } # [doc = "High Resolution Timer: External Event Control Register 1"]
# [inline (always)]
pub const fn eecr1 (self) -> crate :: common :: Reg < regs :: HrtimEecr1 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (944usize) as _) } } # [doc = "High Resolution Timer: External Event Control Register 2"]
# [inline (always)]
pub const fn eecr2 (self) -> crate :: common :: Reg < regs :: HrtimEecr2 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (948usize) as _) } } # [doc = "High Resolution Timer: External Event Control Register 3"]
# [inline (always)]
pub const fn eecr3 (self) -> crate :: common :: Reg < regs :: HrtimEecr3 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (952usize) as _) } } # [doc = "High Resolution Timer: ADC Trigger \\[1, 3\\]
Register"]
# [inline (always)]
pub const fn adc1r (self , n : usize) -> crate :: common :: Reg < regs :: HrtimAdc1r , crate :: common :: RW > { assert ! (n < 2usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (956usize + ([0usize , 8usize]
[n]
as usize)) as _) } } # [doc = "High Resolution Timer: ADC Trigger \\[2, 4\\]
Register"]
# [inline (always)]
pub const fn adc2r (self , n : usize) -> crate :: common :: Reg < regs :: HrtimAdc2r , crate :: common :: RW > { assert ! (n < 2usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (960usize + ([0usize , 8usize]
[n]
as usize)) as _) } } # [doc = "High Resolution Timer: DLL Control Register"]
# [inline (always)]
pub const fn dllcr (self) -> crate :: common :: Reg < regs :: HrtimDllcr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (972usize) as _) } } # [doc = "High Resolution Timer: Fault Input Register 1"]
# [inline (always)]
pub const fn fltinr1 (self) -> crate :: common :: Reg < regs :: HrtimFltinr1 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (976usize) as _) } } # [doc = "High Resolution Timer: Fault Input Register 2"]
# [inline (always)]
pub const fn fltinr2 (self) -> crate :: common :: Reg < regs :: HrtimFltinr2 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (976usize) as _) } } # [doc = "High Resolution Timer: Burst DMA Master timer update Register"]
# [inline (always)]
pub const fn bdmupr (self) -> crate :: common :: Reg < regs :: HrtimBdmupr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (984usize) as _) } } # [doc = "High Resolution Timer: Burst DMA Timer X update Register"]
# [inline (always)]
pub const fn bdtupr (self , n : usize) -> crate :: common :: Reg < regs :: HrtimBdtupr , crate :: common :: RW > { assert ! (n < 5usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (988usize + n * 4usize) as _) } } # [doc = "High Resolution Timer: Burst DMA Data Register"]
# [inline (always)]
pub const fn bdmadr (self) -> crate :: common :: Reg < regs :: HrtimBdmadr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (1008usize) as _) } } } # [doc = "High Resolution Timer: Timing Unit"]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub const fn cr (self) -> crate :: common :: Reg < regs :: Timxcr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0usize) as _) } } # [doc = "Timer X Interrupt Status Register"]
# [inline (always)]
pub const fn isr (self) -> crate :: common :: Reg < regs :: Timxisr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (4usize) as _) } } # [doc = "Timer X Interrupt Clear Register"]
# [inline (always)]
pub const fn icr (self) -> crate :: common :: Reg < regs :: Timxicr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize) as _) } } # [doc = "Timer X DMA / Interrupt Enable Register"]
# [inline (always)]
pub const fn dier (self) -> crate :: common :: Reg < regs :: Timxdier , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (12usize) as _) } } # [doc = "Timer X Counter Register"]
# [inline (always)]
pub const fn cnt (self) -> crate :: common :: Reg < regs :: Timxcnt , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (16usize) as _) } } # [doc = "Timer X Period Register"]
# [inline (always)]
pub const fn per (self) -> crate :: common :: Reg < regs :: Timxper , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (20usize) as _) } } # [doc = "Timer X Repetition Register"]
# [inline (always)]
pub const fn rep (self) -> crate :: common :: Reg < regs :: Timxrep , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (24usize) as _) } } # [doc = "Timer X Compare X Register"]
# [inline (always)]
pub const fn cmp (self , n : usize) -> crate :: common :: Reg < regs :: Timxcmp , crate :: common :: RW > { assert ! (n < 4usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (28usize + ([0usize , 8usize , 12usize , 16usize]
[n]
as usize)) as _) } } # [doc = "Timer X Compare X Compound Register"]
# [inline (always)]
pub const fn cmpc (self , n : usize) -> crate :: common :: Reg < regs :: Timxcmpc , crate :: common :: RW > { assert ! (n < 1usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (32usize + ([0usize]
[n]
as usize)) as _) } } # [doc = "Timer X Capture X Register"]
# [inline (always)]
pub const fn cpt (self , n : usize) -> crate :: common :: Reg < regs :: Timxcpt , crate :: common :: R > { assert ! (n < 2usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (48usize + n * 4usize) as _) } } # [doc = "Timer X Deadtime Register"]
# [inline (always)]
pub const fn dt (self) -> crate :: common :: Reg < regs :: Timxdt , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (56usize) as _) } } # [doc = "Timer X Output X Set Register"]
# [inline (always)]
pub const fn setr (self , n : usize) -> crate :: common :: Reg < regs :: Timxsetr , crate :: common :: RW > { assert ! (n < 2usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (60usize + ([0usize , 8usize]
[n]
as usize)) as _) } } # [doc = "Timer X Output X Reset Register"]
# [inline (always)]
pub const fn rstr (self , n : usize) -> crate :: common :: Reg < regs :: Timxrstr , crate :: common :: RW > { assert ! (n < 2usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (64usize + ([0usize , 8usize]
[n]
as usize)) as _) } } # [doc = "Timer X External Event Filtering Register 1"]
# [inline (always)]
pub const fn eef (self , n : usize) -> crate :: common :: Reg < regs :: Timxeef , crate :: common :: RW > { assert ! (n < 2usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (76usize + ([0usize , 4usize]
[n]
as usize)) as _) } } # [doc = "Timer X Reset Register"]
# [inline (always)]
pub const fn rst (self) -> crate :: common :: Reg < regs :: Timxrst , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (84usize) as _) } } # [doc = "Timer X Chopper Register"]
# [inline (always)]
pub const fn chp (self) -> crate :: common :: Reg < regs :: Timxchp , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (88usize) as _) } } # [doc = "Timer X Capture X Control Register"]
# [inline (always)]
pub const fn ccr (self , n : usize) -> crate :: common :: Reg < regs :: Timxccr , crate :: common :: RW > { assert ! (n < 2usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (92usize + ([0usize , 4usize]
[n]
as usize)) as _) } } # [doc = "Timer X Output Register"]
# [inline (always)]
pub const fn outr (self) -> crate :: common :: Reg < regs :: Timxoutr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (100usize) as _) } } # [doc = "Timer X Fault Register"]
# [inline (always)]
pub const fn flt (self) -> crate :: common :: Reg < regs :: Timxflt , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (104usize) as _) } } } pub mod regs { # [doc = "High Resolution Timer: ADC Trigger 1 Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
NOEFFECT = 0 , # [doc = "Timer event forces the output to its active state"]
...
INDEPENDENT = 0 , # [doc = "Update done when the DMA burst transfer is completed"]
...
NOEFFECT = 0 , # [doc = "Timer event triggers capture"]
...
OUTPUT1ACTIVE = 0 , # [doc = "Signal applied on output 2 and output 1 forced inactive"]
...
DISABLED = 0 , # [doc = "Trigger generated on DACSync1"]
...
STANDARD = 0 , # [doc = "CMP is recomputed and is active following a capture 1 event"]
...
OUTPUT1_EE6 = 0 , # [doc = "Output 2 delayed idle on external event 6"]
...
DISABLED = 0 , # [doc = "Blanking from counter reset/roll-over to Compare 1"]
...
DISABLED = 0 , # [doc = "Output goes to active state after a fault event"]
...
IGNORED = 0 , # [doc = "Fault input is active and can disable HRTIM outputs"]
...
NOEFFECT = 0 , # [doc = "Timer event forces the output to its inactive state"]
...
OUTPUT1ACTIVE = 0 , # [doc = "Protection occurred when the output 2 was active and output 1 forced inactive"]
...
INACTIVE = 0 , # [doc = "Output is or was active"]
...
ACTIVEHIGH = 0 , # [doc = "Negative polarity (output active low)"]
...
NOEFFECT = 0 , # [doc = "Timer X counter is reset upon timer Y compare Z event"]
...
POSITIVE = 0 , # [doc = "Negative deadtime on falling edge"]
...
POSITIVE = 0 , # [doc = "Negative deadtime on rising edge"]
...
DISABLED = 0 , _RESERVED_1 = 0x01 , # [doc = "Internal event: the HRTIM is synchronized with the on-chip timer"]
...
DISABLED = 0 , _RESERVED_1 = 0x01 , # [doc = "Positive pulse on SCOUT output (16x f_HRTIM clock cycles)"]
...
DISABLED = 0 , # [doc = "Synchronization event resets Timer x"]
...
MASTERSTART = 0 , # [doc = "Master timer Compare 1 event"]
...
DISABLED = 0 , # [doc = "Synchronization event starts Timer x"]
...
INACTIVE = 0 , # [doc = "Delayed idle or balanced idle mode entry"]
...
INDEPENDENT = 0 , # [doc = "Update occurs when the DMA burst transfer is completed"]
