...
# [inline (always)]
pub const fn suspr (self , n : usize) -> crate :: common :: Reg < regs :: Suspr , crate :: common :: RW > { assert ! (n < 8usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (64usize + n * 4usize) as _) } } } pub mod regs { # [doc = "Control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
