...
# [inline (always)]
pub const fn cr (self , n : usize) -> crate :: common :: Reg < regs :: Cr , crate :: common :: RW > { assert ! (n < 2usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0usize + n * 4usize) as _) } } # [doc = "Port input data register (GPIOn_IDR)"]
# [inline (always)]
pub const fn idr (self) -> crate :: common :: Reg < regs :: Idr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize) as _) } } # [doc = "Port output data register (GPIOn_ODR)"]
# [inline (always)]
pub const fn odr (self) -> crate :: common :: Reg < regs :: Odr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (12usize) as _) } } # [doc = "Port bit set/reset register (GPIOn_BSRR)"]
# [inline (always)]
pub const fn bsrr (self) -> crate :: common :: Reg < regs :: Bsrr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (16usize) as _) } } # [doc = "Port bit reset register (GPIOn_BRR)"]
# [inline (always)]
pub const fn brr (self) -> crate :: common :: Reg < regs :: Brr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (20usize) as _) } } # [doc = "Port configuration lock register"]
# [inline (always)]
pub const fn lckr (self) -> crate :: common :: Reg < regs :: Lckr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (24usize) as _) } } } pub mod regs { # [doc = "Port bit reset register (GPIOn_BRR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
ANALOG = 0 , # [doc = "Floating input (reset state)"]
...
PUSHPULL = 0 , # [doc = "Open Drain-Mode"]
...
INPUT = 0 , # [doc = "Output mode 10 MHz"]
