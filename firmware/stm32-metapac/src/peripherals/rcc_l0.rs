...
# [inline (always)]
pub const fn i2c1sel (& self) -> super :: vals :: Icsel { let val = (self . 0 >> 12usize) & 0x03 ; super :: vals :: Icsel :: from_bits (val as u8) } # [doc = "I2C1 clock source selection"]
# [inline (always)]
pub fn set_i2c1sel (& mut self , val : super :: vals :: Icsel) { self . 0 = (self . 0 & ! (0x03 << 12usize)) | (((val . to_bits () as u32) & 0x03) << 12usize) ; } # [doc = "I2C3 clock source selection"]
# [inline (always)]
pub const fn i2c3sel (& self) -> super :: vals :: Icsel { let val = (self . 0 >> 16usize) & 0x03 ; super :: vals :: Icsel :: from_bits (val as u8) } # [doc = "I2C3 clock source selection"]
# [inline (always)]
pub fn set_i2c3sel (& mut self , val : super :: vals :: Icsel) { self . 0 = (self . 0 & ! (0x03 << 16usize)) | (((val . to_bits () as u32) & 0x03) << 16usize) ; } # [doc = "Low Power Timer clock source selection"]
# [inline (always)]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Icsel { # [doc = "APB clock selected as peripheral clock"]
