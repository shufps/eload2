...
# [inline (always)]
pub const fn crrcr (self) -> crate :: common :: Reg < regs :: Crrcr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (152usize) as _) } } } pub mod regs { # [doc = "AHB1 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_lptim2en (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 5usize)) | (((val as u32) & 0x01) << 5usize) ; } # [doc = "DFSDMEN enable"]
# [inline (always)]
pub const fn dfsdmen (& self) -> bool { let val = (self . 0 >> 24usize) & 0x01 ; val != 0 } # [doc = "DFSDMEN enable"]
# [inline (always)]
pub fn set_dfsdmen (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 24usize)) | (((val as u32) & 0x01) << 24usize) ; } } impl Default for Apb1enr2 { # [inline (always)]
...
# [inline (always)]
pub const fn dfsdm_timen (& self) -> bool { let val = (self . 0 >> 24usize) & 0x01 ; val != 0 } # [doc = "DFSDM timer clock enable"]
# [inline (always)]
pub fn set_dfsdm_timen (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 24usize)) | (((val as u32) & 0x01) << 24usize) ; } } impl Default for Apb2enr { # [inline (always)]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Swpmi1sel { PCLK1 = 0 , HSI = 0x01 , } impl Swpmi1sel { # [inline (always)]
