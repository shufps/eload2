...
# [inline (always)]
pub const fn lpmcsr (self) -> crate :: common :: Reg < regs :: Lpmcsr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (84usize) as _) } } } pub mod regs { # [doc = "Buffer table address"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
