...
# [inline (always)]
pub const fn cr2 (self) -> crate :: common :: Reg < regs :: Cr2 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (4usize) as _) } } # [doc = "configuration register 1"]
# [inline (always)]
pub const fn cfg1 (self) -> crate :: common :: Reg < regs :: Cfg1 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize) as _) } } # [doc = "configuration register 2"]
# [inline (always)]
pub const fn cfg2 (self) -> crate :: common :: Reg < regs :: Cfg2 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (12usize) as _) } } # [doc = "Interrupt Enable Register"]
# [inline (always)]
pub const fn ier (self) -> crate :: common :: Reg < regs :: Ier , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (16usize) as _) } } # [doc = "Status Register"]
# [inline (always)]
pub const fn sr (self) -> crate :: common :: Reg < regs :: Sr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (20usize) as _) } } # [doc = "Interrupt/Status Flags Clear Register"]
# [inline (always)]
pub const fn ifcr (self) -> crate :: common :: Reg < regs :: Ifcr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (24usize) as _) } } # [inline (always)]
pub const fn autocr (self) -> crate :: common :: Reg < regs :: Autocr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (28usize) as _) } } # [doc = "Transmit Data Register"]
# [inline (always)]
pub const fn txdr (self) -> crate :: common :: Reg < regs :: Txdr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (32usize) as _) } } # [doc = "Receive Data Register"]
# [inline (always)]
pub const fn rxdr (self) -> crate :: common :: Reg < regs :: Rxdr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (48usize) as _) } } # [doc = "Polynomial Register"]
# [inline (always)]
pub const fn crcpoly (self) -> crate :: common :: Reg < regs :: Crcpoly , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (64usize) as _) } } # [doc = "Transmitter CRC Register"]
# [inline (always)]
pub const fn txcrc (self) -> crate :: common :: Reg < regs :: Txcrc , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (68usize) as _) } } # [doc = "Receiver CRC Register"]
# [inline (always)]
pub const fn rxcrc (self) -> crate :: common :: Reg < regs :: Rxcrc , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (72usize) as _) } } # [doc = "Underrun Data Register"]
# [inline (always)]
pub const fn udrdr (self) -> crate :: common :: Reg < regs :: Udrdr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (76usize) as _) } } } pub mod regs { # [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Rxcrc { Rxcrc (0) } } # [doc = "Receive Data Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_rxdr (& mut self , val : u32) { self . 0 = (self . 0 & ! (0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize) ; } } impl Default for Rxdr { # [inline (always)]
...
fn default () -> Txcrc { Txcrc (0) } } # [doc = "Transmit Data Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_txdr (& mut self , val : u32) { self . 0 = (self . 0 & ! (0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize) ; } } impl Default for Txdr { # [inline (always)]
fn default () -> Txdr { Txdr (0) } } # [doc = "Underrun Data Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
FULLDUPLEX = 0 , # [doc = "Simplex transmitter only"]
...
FIRSTEDGE = 0 , # [doc = "The second clock transition is the first data capture edge"]
...
IDLELOW = 0 , # [doc = "CK to 1 when idle"]
...
RECEIVER = 0 , # [doc = "Transmitter in half duplex mode"]
...
MSBFIRST = 0 , # [doc = "Data is transmitted/received with the LSB first"]
...
SLAVE = 0 , # [doc = "Master configuration"]
...
ALLZEROS = 0 , # [doc = "All ones RX CRC initialization pattern"]
...
PERMANENTLYACTIVE = 0 , # [doc = "RDY signal is overtaken from alternate function input (at master case) or output (at slave case) of the dedicated pin (RDIOP setting takes effect)"]
...
READYHIGH = 0 , # [doc = "low level of the signal means the slave is ready for communication"]
...
ZEROFRAMES = 0 , # [doc = "One frame beyond packing ratio available"]
...
LESSTHAN32 = 0 , # [doc = "At least 32-bit data frame received"]
...
MOTOROLA = 0 , # [doc = "TI SPI protocol"]
...
ACTIVELOW = 0 , # [doc = "High level is active for SS signal"]
...
ASSERTED = 0 , # [doc = "Data frames interleaved with SS not asserted during MIDI"]
...
ALLZEROS = 0 , # [doc = "All ones TX CRC initialization pattern"]
...
RISINGEDGE = 0 , # [doc = "trigger is active on falling edge"]
...
CONSTANT = 0 , # [doc = "Slave repeats last received data frame from master"]
