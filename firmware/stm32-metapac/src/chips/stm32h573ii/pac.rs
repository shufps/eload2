...
; } pub const UID : uid :: Uid = unsafe { uid :: Uid :: from_ptr (0x08ff_f800 as usize as _) } ; pub const TIM2 : timer :: TimGp32 = unsafe { timer :: TimGp32 :: from_ptr (0x4000_0000 as usize as _) } ; pub const TIM3 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4000_0400 as usize as _) } ; pub const TIM4 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4000_0800 as usize as _) } ; pub const TIM5 : timer :: TimGp32 = unsafe { timer :: TimGp32 :: from_ptr (0x4000_0c00 as usize as _) } ; pub const TIM6 : timer :: TimBasic = unsafe { timer :: TimBasic :: from_ptr (0x4000_1000 as usize as _) } ; pub const TIM7 : timer :: TimBasic = unsafe { timer :: TimBasic :: from_ptr (0x4000_1400 as usize as _) } ; pub const TIM12 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4000_1800 as usize as _) } ; pub const TIM13 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4000_1c00 as usize as _) } ; pub const TIM14 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4000_2000 as usize as _) } ; pub const WWDG : wwdg :: Wwdg = unsafe { wwdg :: Wwdg :: from_ptr (0x4000_2c00 as usize as _) } ; pub const IWDG : * mut () = 0x4000_3000 as usize as _ ; pub const SPI2 : spi :: Spi = unsafe { spi :: Spi :: from_ptr (0x4000_3800 as usize as _) } ; pub const SPI3 : spi :: Spi = unsafe { spi :: Spi :: from_ptr (0x4000_3c00 as usize as _) } ; pub const USART2 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_4400 as usize as _) } ; pub const USART3 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_4800 as usize as _) } ; pub const UART4 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_4c00 as usize as _) } ; pub const UART5 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_5000 as usize as _) } ; pub const I2C1 : i2c :: I2c = unsafe { i2c :: I2c :: from_ptr (0x4000_5400 as usize as _) } ; pub const I2C2 : i2c :: I2c = unsafe { i2c :: I2c :: from_ptr (0x4000_5800 as usize as _) } ; pub const I3C1 : * mut () = 0x4000_5c00 as usize as _ ; pub const CRS : crs :: Crs = unsafe { crs :: Crs :: from_ptr (0x4000_6000 as usize as _) } ; pub const USART6 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_6400 as usize as _) } ; pub const USART10 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_6800 as usize as _) } ; pub const USART11 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_6c00 as usize as _) } ; pub const CEC : * mut () = 0x4000_7000 as usize as _ ; pub const UART7 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_7800 as usize as _) } ; pub const UART8 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_7c00 as usize as _) } ; pub const UART9 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_8000 as usize as _) } ; pub const UART12 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_8400 as usize as _) } ; pub const DTS : * mut () = 0x4000_8c00 as usize as _ ; pub const LPTIM2 : * mut () = 0x4000_9400 as usize as _ ; pub const FDCAN1 : can :: Fdcan = unsafe { can :: Fdcan :: from_ptr (0x4000_a400 as usize as _) } ; pub const FDCAN2 : can :: Fdcan = unsafe { can :: Fdcan :: from_ptr (0x4000_a800 as usize as _) } ; pub const FDCANRAM1 : fdcanram :: Fdcanram = unsafe { fdcanram :: Fdcanram :: from_ptr (0x4000_ac00 as usize as _) } ; pub const FDCANRAM2 : fdcanram :: Fdcanram = unsafe { fdcanram :: Fdcanram :: from_ptr (0x4000_af50 as usize as _) } ; pub const UCPD1 : ucpd :: Ucpd = unsafe { ucpd :: Ucpd :: from_ptr (0x4000_dc00 as usize as _) } ; pub const TIM1 : timer :: TimAdv = unsafe { timer :: TimAdv :: from_ptr (0x4001_2c00 as usize as _) } ; pub const SPI1 : spi :: Spi = unsafe { spi :: Spi :: from_ptr (0x4001_3000 as usize as _) } ; pub const TIM8 : timer :: TimAdv = unsafe { timer :: TimAdv :: from_ptr (0x4001_3400 as usize as _) } ; pub const USART1 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4001_3800 as usize as _) } ; pub const TIM15 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4001_4000 as usize as _) } ; pub const TIM16 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4001_4400 as usize as _) } ; pub const TIM17 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4001_4800 as usize as _) } ; pub const SPI4 : spi :: Spi = unsafe { spi :: Spi :: from_ptr (0x4001_4c00 as usize as _) } ; pub const SPI6 : spi :: Spi = unsafe { spi :: Spi :: from_ptr (0x4001_5000 as usize as _) } ; pub const SAI1 : * mut () = 0x4001_5400 as usize as _ ; pub const SAI2 : * mut () = 0x4001_5800 as usize as _ ; pub const USB : usb :: Usb = unsafe { usb :: Usb :: from_ptr (0x4001_6000 as usize as _) } ; pub const USBRAM : usbram :: Usbram = unsafe { usbram :: Usbram :: from_ptr (0x4001_6400 as usize as _) } ; pub const GPDMA1 : gpdma :: Gpdma = unsafe { gpdma :: Gpdma :: from_ptr (0x4002_0000 as usize as _) } ; pub const GPDMA2 : gpdma :: Gpdma = unsafe { gpdma :: Gpdma :: from_ptr (0x4002_1000 as usize as _) } ; pub const FLASH : flash :: Flash = unsafe { flash :: Flash :: from_ptr (0x4002_2000 as usize as _) } ; pub const CRC : crc :: Crc = unsafe { crc :: Crc :: from_ptr (0x4002_3000 as usize as _) } ; pub const CORDIC : cordic :: Cordic = unsafe { cordic :: Cordic :: from_ptr (0x4002_3800 as usize as _) } ; pub const FMAC : fmac :: Fmac = unsafe { fmac :: Fmac :: from_ptr (0x4002_3c00 as usize as _) } ; pub const ETH : eth :: Eth = unsafe { eth :: Eth :: from_ptr (0x4002_8000 as usize as _) } ; pub const ICACHE : * mut () = 0x4003_0400 as usize as _ ; pub const DCACHE1 : * mut () = 0x4003_1400 as usize as _ ; pub const GPIOA : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4202_0000 as usize as _) } ; pub const GPIOB : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4202_0400 as usize as _) } ; pub const GPIOC : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4202_0800 as usize as _) } ; pub const GPIOD : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4202_0c00 as usize as _) } ; pub const GPIOE : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4202_1000 as usize as _) } ; pub const GPIOF : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4202_1400 as usize as _) } ; pub const GPIOG : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4202_1800 as usize as _) } ; pub const GPIOH : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4202_1c00 as usize as _) } ; pub const GPIOI : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4202_2000 as usize as _) } ; pub const ADC1 : * mut () = 0x4202_8000 as usize as _ ; pub const ADC2 : * mut () = 0x4202_8100 as usize as _ ; pub const ADC_COMMON : * mut () = 0x4202_8300 as usize as _ ; pub const DAC1 : dac :: Dac = unsafe { dac :: Dac :: from_ptr (0x4202_8400 as usize as _) } ; pub const DCMI : dcmi :: Dcmi = unsafe { dcmi :: Dcmi :: from_ptr (0x4202_c000 as usize as _) } ; pub const PSSI : * mut () = 0x4202_c400 as usize as _ ; pub const AES : * mut () = 0x420c_0000 as usize as _ ; pub const HASH : hash :: Hash = unsafe { hash :: Hash :: from_ptr (0x420c_0400 as usize as _) } ; pub const RNG : rng :: Rng = unsafe { rng :: Rng :: from_ptr (0x420c_0800 as usize as _) } ; pub const SAES : * mut () = 0x420c_0c00 as usize as _ ; pub const PKA : * mut () = 0x420c_2000 as usize as _ ; pub const SYSCFG : syscfg :: Syscfg = unsafe { syscfg :: Syscfg :: from_ptr (0x4400_0400 as usize as _) } ; pub const SPI5 : spi :: Spi = unsafe { spi :: Spi :: from_ptr (0x4400_2000 as usize as _) } ; pub const LPUART1 : usart :: Lpuart = unsafe { usart :: Lpuart :: from_ptr (0x4400_2400 as usize as _) } ; pub const I2C3 : i2c :: I2c = unsafe { i2c :: I2c :: from_ptr (0x4400_2800 as usize as _) } ; pub const I2C4 : i2c :: I2c = unsafe { i2c :: I2c :: from_ptr (0x4400_2c00 as usize as _) } ; pub const LPTIM1 : * mut () = 0x4400_4400 as usize as _ ; pub const LPTIM3 : * mut () = 0x4400_4800 as usize as _ ; pub const LPTIM4 : * mut () = 0x4400_4c00 as usize as _ ; pub const LPTIM5 : * mut () = 0x4400_5000 as usize as _ ; pub const LPTIM6 : * mut () = 0x4400_5400 as usize as _ ; pub const VREFBUF : * mut () = 0x4400_7400 as usize as _ ; pub const RTC : rtc :: Rtc = unsafe { rtc :: Rtc :: from_ptr (0x4400_7800 as usize as _) } ; pub const TAMP : * mut () = 0x4400_7c00 as usize as _ ; pub const PWR : pwr :: Pwr = unsafe { pwr :: Pwr :: from_ptr (0x4402_0800 as usize as _) } ; pub const RCC : rcc :: Rcc = unsafe { rcc :: Rcc :: from_ptr (0x4402_0c00 as usize as _) } ; pub const EXTI : exti :: Exti = unsafe { exti :: Exti :: from_ptr (0x4402_2000 as usize as _) } ; pub const DBGMCU : * mut () = 0x4402_4000 as usize as _ ; pub const OTFDEC1 : * mut () = 0x4600_5000 as usize as _ ; pub const SDMMC1 : sdmmc :: Sdmmc = unsafe { sdmmc :: Sdmmc :: from_ptr (0x4600_8000 as usize as _) } ; pub const SDMMC2 : sdmmc :: Sdmmc = unsafe { sdmmc :: Sdmmc :: from_ptr (0x4600_8c00 as usize as _) } ; pub const OCTOSPI1 : octospi :: Octospi = unsafe { octospi :: Octospi :: from_ptr (0x4700_1400 as usize as _) } ; pub const FMC : * mut () = 0x6000_0000 as usize as _ ; # [doc = r" Number available in the NVIC for configuring priority"]
# [cfg (feature = "rt")]
