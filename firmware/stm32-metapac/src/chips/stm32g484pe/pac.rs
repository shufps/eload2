...
; } pub const UID : uid :: Uid = unsafe { uid :: Uid :: from_ptr (0x1fff_7590 as usize as _) } ; pub const TIM2 : timer :: TimGp32 = unsafe { timer :: TimGp32 :: from_ptr (0x4000_0000 as usize as _) } ; pub const TIM3 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4000_0400 as usize as _) } ; pub const TIM4 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4000_0800 as usize as _) } ; pub const TIM5 : timer :: TimGp32 = unsafe { timer :: TimGp32 :: from_ptr (0x4000_0c00 as usize as _) } ; pub const TIM6 : timer :: TimBasic = unsafe { timer :: TimBasic :: from_ptr (0x4000_1000 as usize as _) } ; pub const TIM7 : timer :: TimBasic = unsafe { timer :: TimBasic :: from_ptr (0x4000_1400 as usize as _) } ; pub const CRS : crs :: Crs = unsafe { crs :: Crs :: from_ptr (0x4000_2000 as usize as _) } ; pub const TAMP : tamp :: Tamp = unsafe { tamp :: Tamp :: from_ptr (0x4000_2400 as usize as _) } ; pub const RTC : rtc :: Rtc = unsafe { rtc :: Rtc :: from_ptr (0x4000_2800 as usize as _) } ; pub const WWDG : wwdg :: Wwdg = unsafe { wwdg :: Wwdg :: from_ptr (0x4000_2c00 as usize as _) } ; pub const IWDG : iwdg :: Iwdg = unsafe { iwdg :: Iwdg :: from_ptr (0x4000_3000 as usize as _) } ; pub const SPI2 : spi :: Spi = unsafe { spi :: Spi :: from_ptr (0x4000_3800 as usize as _) } ; pub const SPI3 : spi :: Spi = unsafe { spi :: Spi :: from_ptr (0x4000_3c00 as usize as _) } ; pub const USART2 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_4400 as usize as _) } ; pub const USART3 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_4800 as usize as _) } ; pub const UART4 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_4c00 as usize as _) } ; pub const UART5 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_5000 as usize as _) } ; pub const I2C1 : i2c :: I2c = unsafe { i2c :: I2c :: from_ptr (0x4000_5400 as usize as _) } ; pub const I2C2 : i2c :: I2c = unsafe { i2c :: I2c :: from_ptr (0x4000_5800 as usize as _) } ; pub const USB : usb :: Usb = unsafe { usb :: Usb :: from_ptr (0x4000_5c00 as usize as _) } ; pub const USBRAM : usbram :: Usbram = unsafe { usbram :: Usbram :: from_ptr (0x4000_6000 as usize as _) } ; pub const FDCAN1 : can :: Fdcan = unsafe { can :: Fdcan :: from_ptr (0x4000_6400 as usize as _) } ; pub const FDCAN2 : can :: Fdcan = unsafe { can :: Fdcan :: from_ptr (0x4000_6800 as usize as _) } ; pub const FDCAN3 : can :: Fdcan = unsafe { can :: Fdcan :: from_ptr (0x4000_6c00 as usize as _) } ; pub const PWR : pwr :: Pwr = unsafe { pwr :: Pwr :: from_ptr (0x4000_7000 as usize as _) } ; pub const I2C3 : i2c :: I2c = unsafe { i2c :: I2c :: from_ptr (0x4000_7800 as usize as _) } ; pub const LPTIM1 : * mut () = 0x4000_7c00 as usize as _ ; pub const LPUART1 : usart :: Lpuart = unsafe { usart :: Lpuart :: from_ptr (0x4000_8000 as usize as _) } ; pub const I2C4 : i2c :: I2c = unsafe { i2c :: I2c :: from_ptr (0x4000_8400 as usize as _) } ; pub const UCPD1 : ucpd :: Ucpd = unsafe { ucpd :: Ucpd :: from_ptr (0x4000_a000 as usize as _) } ; pub const FDCANRAM1 : fdcanram :: Fdcanram = unsafe { fdcanram :: Fdcanram :: from_ptr (0x4000_a400 as usize as _) } ; pub const FDCANRAM2 : fdcanram :: Fdcanram = unsafe { fdcanram :: Fdcanram :: from_ptr (0x4000_a750 as usize as _) } ; pub const FDCANRAM3 : fdcanram :: Fdcanram = unsafe { fdcanram :: Fdcanram :: from_ptr (0x4000_aaa0 as usize as _) } ; pub const SYSCFG : syscfg :: Syscfg = unsafe { syscfg :: Syscfg :: from_ptr (0x4001_0000 as usize as _) } ; pub const COMP1 : * mut () = 0x4001_0200 as usize as _ ; pub const COMP2 : * mut () = 0x4001_0204 as usize as _ ; pub const COMP3 : * mut () = 0x4001_0208 as usize as _ ; pub const COMP4 : * mut () = 0x4001_020c as usize as _ ; pub const COMP5 : * mut () = 0x4001_0210 as usize as _ ; pub const COMP6 : * mut () = 0x4001_0214 as usize as _ ; pub const COMP7 : * mut () = 0x4001_0218 as usize as _ ; pub const OPAMP1 : opamp :: Opamp = unsafe { opamp :: Opamp :: from_ptr (0x4001_0300 as usize as _) } ; pub const OPAMP2 : opamp :: Opamp = unsafe { opamp :: Opamp :: from_ptr (0x4001_0304 as usize as _) } ; pub const OPAMP3 : opamp :: Opamp = unsafe { opamp :: Opamp :: from_ptr (0x4001_0308 as usize as _) } ; pub const OPAMP4 : opamp :: Opamp = unsafe { opamp :: Opamp :: from_ptr (0x4001_030c as usize as _) } ; pub const OPAMP5 : opamp :: Opamp = unsafe { opamp :: Opamp :: from_ptr (0x4001_0310 as usize as _) } ; pub const OPAMP6 : opamp :: Opamp = unsafe { opamp :: Opamp :: from_ptr (0x4001_0314 as usize as _) } ; pub const EXTI : exti :: Exti = unsafe { exti :: Exti :: from_ptr (0x4001_0400 as usize as _) } ; pub const TIM1 : timer :: TimAdv = unsafe { timer :: TimAdv :: from_ptr (0x4001_2c00 as usize as _) } ; pub const SPI1 : spi :: Spi = unsafe { spi :: Spi :: from_ptr (0x4001_3000 as usize as _) } ; pub const TIM8 : timer :: TimAdv = unsafe { timer :: TimAdv :: from_ptr (0x4001_3400 as usize as _) } ; pub const USART1 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4001_3800 as usize as _) } ; pub const SPI4 : spi :: Spi = unsafe { spi :: Spi :: from_ptr (0x4001_3c00 as usize as _) } ; pub const TIM15 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4001_4000 as usize as _) } ; pub const TIM16 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4001_4400 as usize as _) } ; pub const TIM17 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4001_4800 as usize as _) } ; pub const TIM20 : timer :: TimAdv = unsafe { timer :: TimAdv :: from_ptr (0x4001_5000 as usize as _) } ; pub const SAI1 : sai :: Sai = unsafe { sai :: Sai :: from_ptr (0x4001_5400 as usize as _) } ; pub const HRTIM1 : hrtim :: Hrtim = unsafe { hrtim :: Hrtim :: from_ptr (0x4001_6800 as usize as _) } ; pub const DMA1 : bdma :: Dma = unsafe { bdma :: Dma :: from_ptr (0x4002_0000 as usize as _) } ; pub const DMA2 : bdma :: Dma = unsafe { bdma :: Dma :: from_ptr (0x4002_0400 as usize as _) } ; pub const DMAMUX1 : dmamux :: Dmamux = unsafe { dmamux :: Dmamux :: from_ptr (0x4002_0800 as usize as _) } ; pub const CORDIC : cordic :: Cordic = unsafe { cordic :: Cordic :: from_ptr (0x4002_0c00 as usize as _) } ; pub const RCC : rcc :: Rcc = unsafe { rcc :: Rcc :: from_ptr (0x4002_1000 as usize as _) } ; pub const FMAC : fmac :: Fmac = unsafe { fmac :: Fmac :: from_ptr (0x4002_1400 as usize as _) } ; pub const FLASH : flash :: Flash = unsafe { flash :: Flash :: from_ptr (0x4002_2000 as usize as _) } ; pub const CRC : crc :: Crc = unsafe { crc :: Crc :: from_ptr (0x4002_3000 as usize as _) } ; pub const GPIOA : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4800_0000 as usize as _) } ; pub const GPIOB : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4800_0400 as usize as _) } ; pub const GPIOC : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4800_0800 as usize as _) } ; pub const GPIOD : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4800_0c00 as usize as _) } ; pub const GPIOE : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4800_1000 as usize as _) } ; pub const GPIOF : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4800_1400 as usize as _) } ; pub const GPIOG : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4800_1800 as usize as _) } ; pub const ADC1 : adc :: Adc = unsafe { adc :: Adc :: from_ptr (0x5000_0000 as usize as _) } ; pub const ADC2 : adc :: Adc = unsafe { adc :: Adc :: from_ptr (0x5000_0100 as usize as _) } ; pub const ADC_COMMON : adccommon :: AdcCommon = unsafe { adccommon :: AdcCommon :: from_ptr (0x5000_0300 as usize as _) } ; pub const ADC3 : adc :: Adc = unsafe { adc :: Adc :: from_ptr (0x5000_0400 as usize as _) } ; pub const ADC4 : adc :: Adc = unsafe { adc :: Adc :: from_ptr (0x5000_0500 as usize as _) } ; pub const ADC5 : adc :: Adc = unsafe { adc :: Adc :: from_ptr (0x5000_0600 as usize as _) } ; pub const DAC1 : dac :: Dac = unsafe { dac :: Dac :: from_ptr (0x5000_0800 as usize as _) } ; pub const DAC2 : dac :: Dac = unsafe { dac :: Dac :: from_ptr (0x5000_0c00 as usize as _) } ; pub const DAC3 : dac :: Dac = unsafe { dac :: Dac :: from_ptr (0x5000_1000 as usize as _) } ; pub const DAC4 : dac :: Dac = unsafe { dac :: Dac :: from_ptr (0x5000_1400 as usize as _) } ; pub const AES : aes :: Aes = unsafe { aes :: Aes :: from_ptr (0x5006_0000 as usize as _) } ; pub const RNG : rng :: Rng = unsafe { rng :: Rng :: from_ptr (0x5006_0800 as usize as _) } ; pub const FMC : * mut () = 0x6000_0000 as usize as _ ; pub const QUADSPI1 : quadspi :: Quadspi = unsafe { quadspi :: Quadspi :: from_ptr (0xa000_1000 as usize as _) } ; pub const DBGMCU : dbgmcu :: Dbgmcu = unsafe { dbgmcu :: Dbgmcu :: from_ptr (0xe004_2000 as usize as _) } ; # [doc = r" Number available in the NVIC for configuring priority"]
# [cfg (feature = "rt")]
...
#[path="../../peripherals/flash_g4.rs"] pub mod flash;
