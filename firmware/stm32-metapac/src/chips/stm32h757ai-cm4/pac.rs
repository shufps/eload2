...
; } pub const UID : uid :: Uid = unsafe { uid :: Uid :: from_ptr (0x1ff1_e800 as usize as _) } ; pub const TIM2 : timer :: TimGp32 = unsafe { timer :: TimGp32 :: from_ptr (0x4000_0000 as usize as _) } ; pub const TIM3 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4000_0400 as usize as _) } ; pub const TIM4 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4000_0800 as usize as _) } ; pub const TIM5 : timer :: TimGp32 = unsafe { timer :: TimGp32 :: from_ptr (0x4000_0c00 as usize as _) } ; pub const TIM6 : timer :: TimBasic = unsafe { timer :: TimBasic :: from_ptr (0x4000_1000 as usize as _) } ; pub const TIM7 : timer :: TimBasic = unsafe { timer :: TimBasic :: from_ptr (0x4000_1400 as usize as _) } ; pub const TIM12 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4000_1800 as usize as _) } ; pub const TIM13 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4000_1c00 as usize as _) } ; pub const TIM14 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4000_2000 as usize as _) } ; pub const LPTIM1 : * mut () = 0x4000_2400 as usize as _ ; pub const WWDG2 : wwdg :: Wwdg = unsafe { wwdg :: Wwdg :: from_ptr (0x4000_2c00 as usize as _) } ; pub const SPI2 : spi :: Spi = unsafe { spi :: Spi :: from_ptr (0x4000_3800 as usize as _) } ; pub const SPI3 : spi :: Spi = unsafe { spi :: Spi :: from_ptr (0x4000_3c00 as usize as _) } ; pub const USART2 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_4400 as usize as _) } ; pub const USART3 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_4800 as usize as _) } ; pub const UART4 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_4c00 as usize as _) } ; pub const UART5 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_5000 as usize as _) } ; pub const I2C1 : i2c :: I2c = unsafe { i2c :: I2c :: from_ptr (0x4000_5400 as usize as _) } ; pub const I2C2 : i2c :: I2c = unsafe { i2c :: I2c :: from_ptr (0x4000_5800 as usize as _) } ; pub const I2C3 : i2c :: I2c = unsafe { i2c :: I2c :: from_ptr (0x4000_5c00 as usize as _) } ; pub const CEC : * mut () = 0x4000_6c00 as usize as _ ; pub const DAC1 : dac :: Dac = unsafe { dac :: Dac :: from_ptr (0x4000_7400 as usize as _) } ; pub const UART7 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_7800 as usize as _) } ; pub const UART8 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_7c00 as usize as _) } ; pub const CRS : crs :: Crs = unsafe { crs :: Crs :: from_ptr (0x4000_8400 as usize as _) } ; pub const SWPMI1 : * mut () = 0x4000_8800 as usize as _ ; pub const OPAMP1 : * mut () = 0x4000_9000 as usize as _ ; pub const OPAMP2 : * mut () = 0x4000_9010 as usize as _ ; pub const MDIOS : mdios :: Mdios = unsafe { mdios :: Mdios :: from_ptr (0x4000_9400 as usize as _) } ; pub const FDCAN1 : can :: Fdcan = unsafe { can :: Fdcan :: from_ptr (0x4000_a000 as usize as _) } ; pub const FDCAN2 : can :: Fdcan = unsafe { can :: Fdcan :: from_ptr (0x4000_a400 as usize as _) } ; pub const FDCANRAM : fdcanram :: Fdcanram = unsafe { fdcanram :: Fdcanram :: from_ptr (0x4000_ac00 as usize as _) } ; pub const TIM1 : timer :: TimAdv = unsafe { timer :: TimAdv :: from_ptr (0x4001_0000 as usize as _) } ; pub const TIM8 : timer :: TimAdv = unsafe { timer :: TimAdv :: from_ptr (0x4001_0400 as usize as _) } ; pub const USART1 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4001_1000 as usize as _) } ; pub const USART6 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4001_1400 as usize as _) } ; pub const SPI1 : spi :: Spi = unsafe { spi :: Spi :: from_ptr (0x4001_3000 as usize as _) } ; pub const SPI4 : spi :: Spi = unsafe { spi :: Spi :: from_ptr (0x4001_3400 as usize as _) } ; pub const TIM15 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4001_4000 as usize as _) } ; pub const TIM16 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4001_4400 as usize as _) } ; pub const TIM17 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4001_4800 as usize as _) } ; pub const SPI5 : spi :: Spi = unsafe { spi :: Spi :: from_ptr (0x4001_5000 as usize as _) } ; pub const SAI1 : sai :: Sai = unsafe { sai :: Sai :: from_ptr (0x4001_5800 as usize as _) } ; pub const SAI2 : sai :: Sai = unsafe { sai :: Sai :: from_ptr (0x4001_5c00 as usize as _) } ; pub const SAI3 : sai :: Sai = unsafe { sai :: Sai :: from_ptr (0x4001_6000 as usize as _) } ; pub const DFSDM1 : * mut () = 0x4001_7000 as usize as _ ; pub const HRTIM : hrtim :: Hrtim = unsafe { hrtim :: Hrtim :: from_ptr (0x4001_7400 as usize as _) } ; pub const DMA1 : dma :: Dma = unsafe { dma :: Dma :: from_ptr (0x4002_0000 as usize as _) } ; pub const DMA2 : dma :: Dma = unsafe { dma :: Dma :: from_ptr (0x4002_0400 as usize as _) } ; pub const DMAMUX1 : dmamux :: Dmamux = unsafe { dmamux :: Dmamux :: from_ptr (0x4002_0800 as usize as _) } ; pub const ADC1 : adc :: Adc = unsafe { adc :: Adc :: from_ptr (0x4002_2000 as usize as _) } ; pub const ADC2 : adc :: Adc = unsafe { adc :: Adc :: from_ptr (0x4002_2100 as usize as _) } ; pub const ADC_COMMON : adccommon :: AdcCommon = unsafe { adccommon :: AdcCommon :: from_ptr (0x4002_2300 as usize as _) } ; pub const ETH : eth :: Eth = unsafe { eth :: Eth :: from_ptr (0x4002_8000 as usize as _) } ; pub const USB_OTG_HS : otg :: Otg = unsafe { otg :: Otg :: from_ptr (0x4004_0000 as usize as _) } ; pub const USB_OTG_FS : otg :: Otg = unsafe { otg :: Otg :: from_ptr (0x4008_0000 as usize as _) } ; pub const DCMI : dcmi :: Dcmi = unsafe { dcmi :: Dcmi :: from_ptr (0x4802_0000 as usize as _) } ; pub const CRYP : cryp :: Cryp = unsafe { cryp :: Cryp :: from_ptr (0x4802_1000 as usize as _) } ; pub const HASH : hash :: Hash = unsafe { hash :: Hash :: from_ptr (0x4802_1400 as usize as _) } ; pub const RNG : rng :: Rng = unsafe { rng :: Rng :: from_ptr (0x4802_1800 as usize as _) } ; pub const SDMMC2 : sdmmc :: Sdmmc = unsafe { sdmmc :: Sdmmc :: from_ptr (0x4802_2400 as usize as _) } ; pub const LTDC : * mut () = 0x5000_1000 as usize as _ ; pub const WWDG1 : wwdg :: Wwdg = unsafe { wwdg :: Wwdg :: from_ptr (0x5000_3000 as usize as _) } ; pub const MDMA : * mut () = 0x5200_0000 as usize as _ ; pub const DMA2D : dma2d :: Dma2d = unsafe { dma2d :: Dma2d :: from_ptr (0x5200_1000 as usize as _) } ; pub const FLASH : flash :: Flash = unsafe { flash :: Flash :: from_ptr (0x5200_2000 as usize as _) } ; pub const JPEG : jpeg :: Jpeg = unsafe { jpeg :: Jpeg :: from_ptr (0x5200_3000 as usize as _) } ; pub const FMC : fmc :: Fmc = unsafe { fmc :: Fmc :: from_ptr (0x5200_4000 as usize as _) } ; pub const QUADSPI : quadspi :: Quadspi = unsafe { quadspi :: Quadspi :: from_ptr (0x5200_5000 as usize as _) } ; pub const SDMMC1 : sdmmc :: Sdmmc = unsafe { sdmmc :: Sdmmc :: from_ptr (0x5200_7000 as usize as _) } ; pub const EXTI : exti :: Exti = unsafe { exti :: Exti :: from_ptr (0x5800_0000 as usize as _) } ; pub const SYSCFG : syscfg :: Syscfg = unsafe { syscfg :: Syscfg :: from_ptr (0x5800_0400 as usize as _) } ; pub const LPUART1 : usart :: Lpuart = unsafe { usart :: Lpuart :: from_ptr (0x5800_0c00 as usize as _) } ; pub const SPI6 : spi :: Spi = unsafe { spi :: Spi :: from_ptr (0x5800_1400 as usize as _) } ; pub const I2C4 : i2c :: I2c = unsafe { i2c :: I2c :: from_ptr (0x5800_1c00 as usize as _) } ; pub const LPTIM2 : * mut () = 0x5800_2400 as usize as _ ; pub const LPTIM3 : * mut () = 0x5800_2800 as usize as _ ; pub const LPTIM4 : * mut () = 0x5800_2c00 as usize as _ ; pub const LPTIM5 : * mut () = 0x5800_3000 as usize as _ ; pub const COMP1 : * mut () = 0x5800_380c as usize as _ ; pub const COMP2 : * mut () = 0x5800_3810 as usize as _ ; pub const VREFBUF : * mut () = 0x5800_3c00 as usize as _ ; pub const RTC : rtc :: Rtc = unsafe { rtc :: Rtc :: from_ptr (0x5800_4000 as usize as _) } ; pub const IWDG1 : iwdg :: Iwdg = unsafe { iwdg :: Iwdg :: from_ptr (0x5800_4800 as usize as _) } ; pub const IWDG2 : iwdg :: Iwdg = unsafe { iwdg :: Iwdg :: from_ptr (0x5800_4c00 as usize as _) } ; pub const SAI4 : sai :: Sai = unsafe { sai :: Sai :: from_ptr (0x5800_5400 as usize as _) } ; pub const GPIOA : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x5802_0000 as usize as _) } ; pub const GPIOB : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x5802_0400 as usize as _) } ; pub const GPIOC : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x5802_0800 as usize as _) } ; pub const GPIOD : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x5802_0c00 as usize as _) } ; pub const GPIOE : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x5802_1000 as usize as _) } ; pub const GPIOF : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x5802_1400 as usize as _) } ; pub const GPIOG : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x5802_1800 as usize as _) } ; pub const GPIOH : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x5802_1c00 as usize as _) } ; pub const GPIOI : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x5802_2000 as usize as _) } ; pub const GPIOJ : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x5802_2400 as usize as _) } ; pub const GPIOK : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x5802_2800 as usize as _) } ; pub const RCC : rcc :: Rcc = unsafe { rcc :: Rcc :: from_ptr (0x5802_4400 as usize as _) } ; pub const PWR : pwr :: Pwr = unsafe { pwr :: Pwr :: from_ptr (0x5802_4800 as usize as _) } ; pub const CRC : crc :: Crc = unsafe { crc :: Crc :: from_ptr (0x5802_4c00 as usize as _) } ; pub const BDMA : bdma :: Dma = unsafe { bdma :: Dma :: from_ptr (0x5802_5400 as usize as _) } ; pub const DMAMUX2 : dmamux :: Dmamux = unsafe { dmamux :: Dmamux :: from_ptr (0x5802_5800 as usize as _) } ; pub const ADC3 : adc :: Adc = unsafe { adc :: Adc :: from_ptr (0x5802_6000 as usize as _) } ; pub const ADC3_COMMON : adccommon :: AdcCommon = unsafe { adccommon :: AdcCommon :: from_ptr (0x5802_6300 as usize as _) } ; pub const DBGMCU : dbgmcu :: Dbgmcu = unsafe { dbgmcu :: Dbgmcu :: from_ptr (0x5c00_1000 as usize as _) } ; # [doc = r" Number available in the NVIC for configuring priority"]
# [cfg (feature = "rt")]
...
#[path="../../peripherals/sai_v3.rs"] pub mod sai;
